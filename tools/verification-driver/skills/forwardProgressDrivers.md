...
| `P_DEADLOCK_FLUSH_DRAIN` | Flush while blocked | Fill live entries, assert redirect/flush/cancel while responses are blocked, then release sink | Killed entries are freed and cannot block new legal work forever | Flush progress checker |
