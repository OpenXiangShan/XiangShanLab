...
# ![1776133172788-c323aeb2-1213-4ce1-9f5a-afd80b5d09d7.png](./img/aRBrkEUlAGMcBvfA/1776133172788-c323aeb2-1213-4ce1-9f5a-afd80b5d09d7-552853.png)

无条件跳转，源操作数为pc以及固定数据4，跳转目标为pc加上offset。

选择的追踪指令是如下这条：

![1776148496483-3305c69f-853d-44d7-b386-caa6c2aa3322.png](./img/aRBrkEUlAGMcBvfA/1776148496483-3305c69f-853d-44d7-b386-caa6c2aa3322-208259.png)
...
![1776153175392-a342f8a2-0428-46b0-ae4c-4975bbea3323.png](./img/aRBrkEUlAGMcBvfA/1776153175392-a342f8a2-0428-46b0-ae4c-4975bbea3323-583321.png)

在波形中可以确定这些信息，包括在valid信号有效的条件下，可以确定该指令的指令码为0x062000ef，便是上面我们追踪的指令。查看对于这条指令的译码结果：

包括于*srcType\_0以及*srcType\_1两个值都是0，

![1776153568592-e3d55a76-af20-4a78-b1d3-52ba5becf562.png](./img/aRBrkEUlAGMcBvfA/1776153568592-e3d55a76-af20-4a78-b1d3-52ba5becf562-008281.png)

看代码发现了两个源操作数是来自于pc以及imm的，行为是正确的。

而不管是来自于pc还是来自imm的数，其具体的数值都是如下的结果：

![1776153684579-031ef161-4cc6-4a20-ae85-413ec294a81d.png](./img/aRBrkEUlAGMcBvfA/1776153684579-031ef161-4cc6-4a20-ae85-413ec294a81d-575291.png)
...
![1776154342514-bdd6c70e-aa82-400a-8b5d-91e1f267f8bd.png](./img/aRBrkEUlAGMcBvfA/1776154342514-bdd6c70e-aa82-400a-8b5d-91e1f267f8bd-077954.png)

从代码中可以确定，fuType的把热编码的第0位拉高即表明当前指令是一条jump相关的指令，波形行为正确。

![1776154430741-91ff7c60-69f1-42d4-891b-0794350a22ac.png](./img/aRBrkEUlAGMcBvfA/1776154430741-91ff7c60-69f1-42d4-891b-0794350a22ac-273189.png)
...
![1776155166584-9799c37c-0840-4365-9005-9f61582cb99b.png](./img/aRBrkEUlAGMcBvfA/1776155166584-9799c37c-0840-4365-9005-9f61582cb99b-590726.png)
