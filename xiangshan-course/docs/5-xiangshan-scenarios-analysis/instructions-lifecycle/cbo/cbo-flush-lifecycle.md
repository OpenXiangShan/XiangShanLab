...
|---|---|
| **指令名称** | `cbo.flush rs1` |
| **编码格式** | `000000000010_rs1[4:0]_010_00000_0001111`，32 位；`imm[11:0]=000000000010`、`funct3=010`、`rd=00000`、`opcode=0001111`；`rs1` 为地址源；本地内部操作编码 `LSUOpType.cbo_flush=0b1101` 不属于上述指令位字段 |
