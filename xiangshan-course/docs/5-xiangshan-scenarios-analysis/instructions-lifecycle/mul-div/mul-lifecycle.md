...
| **编码格式** | `mul`：`0000001_rs2[4:0]_rs1[4:0]_000_rd[4:0]_0110011`，32 位；`funct7=0000001`、`funct3=000`、`opcode=0110011`<br>`mulh`：`0000001_rs2[4:0]_rs1[4:0]_001_rd[4:0]_0110011`，32 位；`funct7=0000001`、`funct3=001`、`opcode=0110011`<br>`mulhsu`：`0000001_rs2[4:0]_rs1[4:0]_010_rd[4:0]_0110011`，32 位；`funct7=0000001`、`funct3=010`、`opcode=0110011`<br>`mulhu`：`0000001_rs2[4:0]_rs1[4:0]_011_rd[4:0]_0110011`，32 位；`funct7=0000001`、`funct3=011`、`opcode=0110011`<br>`mulw`：`0000001_rs2[4:0]_rs1[4:0]_000_rd[4:0]_0111011`，32 位；`funct7=0000001`、`funct3=000`、`opcode=0111011` |
