...
| **编码格式** | `lb`：`imm[11:0]_rs1[4:0]_000_rd[4:0]_0000011`，32 位；`funct3=000`、`opcode=0000011`<br>`lh`：`imm[11:0]_rs1[4:0]_001_rd[4:0]_0000011`，32 位；`funct3=001`、`opcode=0000011`<br>`lw`：`imm[11:0]_rs1[4:0]_010_rd[4:0]_0000011`，32 位；`funct3=010`、`opcode=0000011`<br>`ld`：`imm[11:0]_rs1[4:0]_011_rd[4:0]_0000011`，32 位；`funct3=011`、`opcode=0000011`<br>`lbu`：`imm[11:0]_rs1[4:0]_100_rd[4:0]_0000011`，32 位；`funct3=100`、`opcode=0000011`<br>`lhu`：`imm[11:0]_rs1[4:0]_101_rd[4:0]_0000011`，32 位；`funct3=101`、`opcode=0000011`<br>`lwu`：`imm[11:0]_rs1[4:0]_110_rd[4:0]_0000011`，32 位；`funct3=110`、`opcode=0000011` |
