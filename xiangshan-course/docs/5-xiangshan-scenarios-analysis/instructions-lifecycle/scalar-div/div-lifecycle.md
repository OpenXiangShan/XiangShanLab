...
| **编码格式** | `div`：`0000001_rs2[4:0]_rs1[4:0]_100_rd[4:0]_0110011`，32 位；`funct7=0000001`、`funct3=100`、`opcode=0110011`<br>`divu`：`0000001_rs2[4:0]_rs1[4:0]_101_rd[4:0]_0110011`，32 位；`funct7=0000001`、`funct3=101`、`opcode=0110011`<br>`rem`：`0000001_rs2[4:0]_rs1[4:0]_110_rd[4:0]_0110011`，32 位；`funct7=0000001`、`funct3=110`、`opcode=0110011`<br>`remu`：`0000001_rs2[4:0]_rs1[4:0]_111_rd[4:0]_0110011`，32 位；`funct7=0000001`、`funct3=111`、`opcode=0110011`<br>`divw`：`0000001_rs2[4:0]_rs1[4:0]_100_rd[4:0]_0111011`，32 位；`funct7=0000001`、`funct3=100`、`opcode=0111011`<br>`divuw`：`0000001_rs2[4:0]_rs1[4:0]_101_rd[4:0]_0111011`，32 位；`funct7=0000001`、`funct3=101`、`opcode=0111011`<br>`remw`：`0000001_rs2[4:0]_rs1[4:0]_110_rd[4:0]_0111011`，32 位；`funct7=0000001`、`funct3=110`、`opcode=0111011`<br>`remuw`：`0000001_rs2[4:0]_rs1[4:0]_111_rd[4:0]_0111011`，32 位；`funct7=0000001`、`funct3=111`、`opcode=0111011` |
