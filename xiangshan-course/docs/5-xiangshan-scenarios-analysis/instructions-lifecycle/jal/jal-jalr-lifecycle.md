...
|---|---|
| **指令名称** | `jal`、`jalr` |
| **编码格式** | `jal`：`imm[20]_imm[10:1]_imm[11]_imm[19:12]_rd[4:0]_1101111`，32 位；`opcode=1101111`<br>`jalr`：`imm[11:0]_rs1[4:0]_000_rd[4:0]_1100111`，32 位；`funct3=000`、`opcode=1100111` |
| **RISC-V 扩展** | `RV64I` |
