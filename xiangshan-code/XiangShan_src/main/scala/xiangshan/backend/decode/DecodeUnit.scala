...
//  HISIONDebug("it's HISION in:  instr=%x pc=%x excepVec=%b crossPageIPFFix=%d\n",
//    ctrl_flow.instr, ctrl_flow.debug.get.pc, ctrl_flow.exceptionVec.asUInt,
//    ctrl_flow.crossPageIPFFix)
