# Commit Log
- Issue: #3367
- Issue URL: https://github.com/OpenXiangShan/XiangShan/pull/3367
- Issue state: closed
- Tested RTL commit: -
- Related PR: #3367
- PR URL: https://github.com/OpenXiangShan/XiangShan/pull/3367
- Changed files: 4
- Additions: 207
- Deletions: 144
...
index bef4a76f8e1..92b29503682 100644
...
@@ -194,6 +194,8 @@ abstract class BasePredictor(implicit p: Parameters) extends XSModule
   io.s2_ready := true.B
   io.s3_ready := true.B
...
@@ -448,6 +450,8 @@ class Predictor(implicit p: Parameters) extends XSModule with HasBPUConst with H
...
index f6db5daba62..a0816890541 100644
...
index 6340178f70f..cf62a67a859 100644
--- a/src/main/scala/xiangshan/frontend/ITTAGE.scala
+++ b/src/main/scala/xiangshan/frontend/ITTAGE.scala
@@ -52,8 +52,7 @@ trait ITTageParams extends HasXSParameter with HasBPUParameter {
...
@@ -63,6 +62,7 @@ trait ITTageHasFoldedHistory {
     }
     else 0.U
   }
...
@@ -88,9 +88,8 @@ class ITTageResp(implicit p: Parameters) extends ITTageBundle {
...
@@ -106,23 +105,8 @@ class ITTageUpdate(implicit p: Parameters) extends ITTageBundle {
 // reuse TAGE Implementation
...
+    val update = Flipped(DecoupledIO(new ITTageUpdate))
   ...
   val SRAM_SIZE=128
@@ -155,10 +139,6 @@ class ITTageTable
...
@@ -221,20 +201,16 @@ class ITTageTable
...
@@ -242,30 +218,39 @@ class ITTageTable
...
@@ -276,29 +261,24 @@ class ITTageTable
...
@@ -438,14 +418,127 @@ class ITTage(implicit p: Parameters) extends BaseITTage {
   updateU       := DontCare
...
@@ -494,16 +587,6 @@ class ITTage(implicit p: Parameters) extends BaseITTage {
     yield
...
@@ -514,48 +597,49 @@ class ITTage(implicit p: Parameters) extends BaseITTage {
...
@@ -575,22 +659,28 @@ class ITTage(implicit p: Parameters) extends BaseITTage {
...
@@ -609,41 +699,6 @@ class ITTage(implicit p: Parameters) extends BaseITTage {
...
@@ -660,8 +715,7 @@ class ITTage(implicit p: Parameters) extends BaseITTage {
     }
   }
...
index 32cc149b87a..152da088796 100644
...
@@ -1466,6 +1467,7 @@ class Ftq(implicit p: Parameters) extends XSModule with HasCircularQueuePtrHelpe
