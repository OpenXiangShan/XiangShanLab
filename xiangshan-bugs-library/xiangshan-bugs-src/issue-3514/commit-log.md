# Commit Log
- Issue: #3514
- Issue URL: https://github.com/OpenXiangShan/XiangShan/pull/3514
- Issue state: closed
- Tested RTL commit: -
- Related PR: #3514
- PR URL: https://github.com/OpenXiangShan/XiangShan/pull/3514
- Changed files: 2
- Additions: 21
- Deletions: 3
...
index 32cc149b87a..f29987c4985 100644
--- a/src/main/scala/xiangshan/frontend/NewFtq.scala
+++ b/src/main/scala/xiangshan/frontend/NewFtq.scala
@@ -907,7 +907,7 @@ class Ftq(implicit p: Parameters) extends XSModule with HasCircularQueuePtrHelpe
...
@@ -982,24 +982,36 @@ class Ftq(implicit p: Parameters) extends XSModule with HasCircularQueuePtrHelpe
...
index 99d1a131831..13bfd9bb546 100644
...
@@ -503,12 +504,16 @@ class RAS(implicit p: Parameters) extends BasePredictor {
