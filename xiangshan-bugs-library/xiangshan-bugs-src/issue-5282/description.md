...
Under a specific instruction sequence, when executing the illegal instruction `0x01e4f4f3`, the `mtval` produced by NEMU and Spike (XS-version) differs from XiangShan.

Notably, this bug cannot be triggered by executing the illegal instruction alone — it only appears when certain preceding context is present. According to the RISC-V specification, XiangShan’s output appears to be the correct one. I am reporting this here because both NEMU and Spike (XS-version) seem to produce an incorrect `mtval` in this scenario.
...
the first commit instr pc of DUT is 0x0000000080001058
the first commit instr pc of REF is 0x0000000080001058

============== Commit Group Trace (Core 0) ==============
commit group [00]: pc 0080001024 cmtcnt 1
commit group [01]: pc 0080001028 cmtcnt 1
commit group [02]: pc 008000102c cmtcnt 1
commit group [03]: pc 0080001030 cmtcnt 1
...
commit group [08]: pc 0080001038 cmtcnt 4
commit group [09]: pc 0080001048 cmtcnt 1
...
commit group [14]: pc 0080001050 cmtcnt 2
commit group [15]: pc 0080001058 cmtcnt 2 <--

============== Commit Instr Trace ==============
[00] commit pc 0000000080001014 inst 0006f057 wen 0 dst 00 data 0000000000000000 idx 059
[01] exception pc 0000000080001018 inst 009b5657 cause 0000000000000002
[02] commit pc 0000000080001000 inst 341026f3 wen 1 dst 13 data 0000000080001018 idx 05a
[03] commit pc 0000000080001004 inst 00468693 wen 1 dst 13 data 000000008000101c idx 05b
[04] commit pc 0000000080001008 inst 34169073 wen 0 dst 00 data 0000000000000000 idx 05c
[05] commit pc 000000008000100c inst 30200073 wen 0 dst 00 data 0000000000000000 idx 05d
[06] exception pc 000000008000101c inst 18efb6af cause 0000000000000007
[07] commit pc 0000000080001000 inst 341026f3 wen 1 dst 13 data 000000008000101c idx 05e
[08] commit pc 0000000080001004 inst 00468693 wen 1 dst 13 data 0000000080001020 idx 05f
[09] commit pc 0000000080001008 inst 34169073 wen 0 dst 00 data 0000000000000000 idx 060
[10] commit pc 000000008000100c inst 30200073 wen 0 dst 00 data 0000000000000000 idx 061
[11] commit pc 0000000080001020 inst 03cc45bb wen 1 dst 11 data ffffffffffffffff idx 062
[12] commit pc 0000000080001024 inst 0c168227 wen 1 dst 32 data 0000000080001020 idx 063 (00)
[13] commit pc 0000000080001028 inst adcfbdd7 wen 1 dst 32 data 1f1f1f1f1f1f1f1f idx 064
[14] commit pc 000000008000102c inst 00b683bb wen 1 dst 07 data ffffffff8000101f idx 065
[15] commit pc 0000000080001030 inst 417e3f57 wen 1 dst 32 data fcfcfcfcfcfcfcfc idx 066
[16] exception pc 0000000080001034 inst 48731ad7 cause 0000000000000002
[17] commit pc 0000000080001000 inst 341026f3 wen 1 dst 13 data 0000000080001034 idx 067
[18] commit pc 0000000080001004 inst 00468693 wen 1 dst 13 data 0000000080001038 idx 068
[19] commit pc 0000000080001008 inst 34169073 wen 0 dst 00 data 0000000000000000 idx 069
[20] commit pc 000000008000100c inst 30200073 wen 0 dst 00 data 0000000000000000 idx 06a
[21] commit pc 0000000080001038 inst 287acab3 wen 1 dst 21 data 0000000000000000 idx 06b
[22] commit pc 0000000080001048 inst 83d32cd7 wen 1 dst 25 data 000200ff02000301 idx 06c
[23] exception pc 000000008000104c inst c14fecf3 cause 0000000000000002
[24] commit pc 0000000080001000 inst 341026f3 wen 1 dst 13 data 000000008000104c idx 06d
[25] commit pc 0000000080001004 inst 00468693 wen 1 dst 13 data 0000000080001050 idx 06e
[26] commit pc 0000000080001008 inst 34169073 wen 0 dst 00 data 0000000000000000 idx 06f
[27] commit pc 000000008000100c inst 30200073 wen 0 dst 00 data 0000000000000000 idx 070
[28] commit pc 0000000080001050 inst 0a263133 wen 1 dst 02 data 0000000000000000 idx 071
[29] commit pc 0000000080001058 inst 0149cf57 wen 1 dst 32 data 0000000000000000 idx 072
[30] commit pc 000000008000105c inst 013cdc13 wen 1 dst 24 data 0000000000000000 idx 073
[31] exception pc 0000000080001060 inst 01e4f4f3 cause 0000000000000002 <--

==============  REF Regs  ==============
---------------- Intger Registers ----------------
  $0: 0x0000000000000000   ra: 0x7fffffffffffffff   sp: 0x0000000000000000   gp: 0x7118cb0f09ab2100 
  tp: 0xfdd349c7ec02cd61   t0: 0x5785c665c02f8d7b   t1: 0x683d6b25493319bb   t2: 0xffffffff8000101f 
  s0: 0x40413e08b7467c24   s1: 0x7ae96bc910a4d5e3   a0: 0x0000000000000000   a1: 0xffffffffffffffff 
  a2: 0x40190e3ec6ed89d6   a3: 0x0000000080001050   a4: 0x8b9848b88a0d4c78   a5: 0x689afecf0e76957f 
  a6: 0x000000000000000f   a7: 0x0000000000000000   s2: 0x0000000000000000   s3: 0x0000000000000000 
  s4: 0x0000000000000000   s5: 0x0000000000000000   s6: 0xbd74b5e488526af1   s7: 0x0000000000000000 
  s8: 0x0000000000000000   s9: 0x0000000000000000  s10: 0x0000000000000000  s11: 0x0000000000000000 
  t3: 0x0000000000000000   t4: 0x0000000000000000   t5: 0x0000000000000000   t6: 0x0000000000001000 
---------------- Float Registers ----------------
 ft0: 0x0000000000000000  ft1: 0xffffffffe2596052  ft2: 0xc70220d4e243aa06  ft3: 0xffffffff09ab2100 
 ft4: 0xffffffffffffcd61  ft5: 0xffffffffffff8d7b  ft6: 0xffffffff493319bb  ft7: 0xffffffffffff0613 
 fs0: 0xffffffffffff7c24  fs1: 0x7ae96bc910a4d5e3  fa0: 0x0b5df9cde9b33603  fa1: 0xffffffffffff0476 
 fa2: 0xffffffffc6ed89d6  fa3: 0x2a8cd3d472789ab1  fa4: 0xffffffffffff4c78  fa5: 0xffffffff0e76957f 
...
pc: 0x0000000080001000  privilege mode: M (mode: 3  v: 0  debug: 0)
   mstatus: 0x8000040a00546780   sstatus: 0x8000000200046700  vsstatus: 0x0000000200000000
   hstatus: 0x0000000200000000  mnstatus: 0x0000000000000008
    mcause: 0x0000000000000002      mepc: 0x0000000080001060     mtval: 0x0000000001e414f3
...
v24: 0xc857b64919bc87bb_ea5be4c1dbc8ffa2  v25: 0x0001000601000200_000200ff02000301  
v26: 0x87c19af4a529206f_0cd43f5d61839947  v27: 0x0100ebdacf9562a0_ffa4d9019dd34dff  
v28: 0x5bcbca38f1d82731_aaedbd7dbe953c84  v29: 0x78372ab9bc59689d_33cb7a6bf8e4a3e5  
v30: 0x29232ae8e1768e25_e231799114cea170  v31: 0xf48c2d0a2c660778_d41aa58285be6654  
  vtype: 0x0000000000000000 vstart: 0x0000000000000000  vxsat: 0x0000000000000000
   vxrm: 0x0000000000000001     vl: 0x0000000000000010   vcsr: 0x0000000000000002
---------------- Triggers ----------------
...
privilegeMode: 3
  mtval different at pc = 0x0080001058, right= 0x0000000001e414f3, wrong = 0x0000000001e4f4f3
Core 0: ABORT at pc = 0x370ed81e9e88
Core-0 instrCnt = 208, cycleCnt = 8,885, IPC = 0.023410
Seed=0 Guest cycle spent: 8,889 (this will be different from cycleCnt if emu loads a snapshot)
Host time spent: 6,445ms
```
...
==============  REF Regs  ==============
zero: 0x0000000000000000   ra: 0x7fffffffffffffff   sp: 0x0000000000000000   gp: 0x7118cb0f09ab2100 
  tp: 0xfdd349c7ec02cd61   t0: 0x5785c665c02f8d7b   t1: 0x683d6b25493319bb   t2: 0xffffffff8000101f 
  s0: 0x40413e08b7467c24   s1: 0x7ae96bc910a4d5e3   a0: 0x0000000000000000   a1: 0xffffffffffffffff 
  a2: 0x40190e3ec6ed89d6   a3: 0x0000000080001050   a4: 0x8b9848b88a0d4c78   a5: 0x689afecf0e76957f 
  a6: 0x000000000000000f   a7: 0x0000000000000000   s2: 0x0000000000000000   s3: 0x0000000000000000 
 ...
 fs8: 0xc228c163d1bcb313  fs9: 0x530dcddb03d80058 fs10: 0xea92f75ade8099bb fs11: 0xbef9b45da40171dd 
 ft8: 0x5099a5df4028e333  ft9: 0x418740071a07d6fc ft10: 0x73ae5b72d5414904 ft11: 0x5b39a09bd0077be5 
pc: 0x0000000080001000 mstatus: 0x8000040a00546780 mcause: 0x0000000000000002 mepc: 0x0000000080001060
                       sstatus: 0x8000000200046700 scause: 0x0000000000000000 sepc: 0x0000000000000000
satp: 0x0000000000000000
mip: 0x0000000000000000 mie: 0x0000000000000000 mscratch: 0x04d607169a82bd3e sscratch: 0x04d607169a82bd3e
mideleg: 0x0000000000001444 medeleg: 0x0000000000000000
mtval: 0x0000000001e414f3 stval: 0x0000000000000000 mtvec: 0x0000000080001000 stvec: 0x0000000000000000
privilege mode:3
...
Core-0 instrCnt = 208, cycleCnt = 8,885, IPC = 0.023410
Seed=0 Guest cycle spent: 8,889 (this will be different from cycleCnt if emu loads a snapshot)
Host time spent: 6,872ms
```

### Expected behavior

`mtval = 0x0000000001e4f4f3`

### To Reproduce

To help investigate the cause, I prepared two test cases. Both contain the instruction 0x01e4f4f3, but only the one with the specific preceding instruction sequence can trigger this issue.

Test case with the specific sequence that triggers the issue: [seeds_750_mismatch.zip](https://github.com/user-attachments/files/23838593/seeds_750_mismatch.zip)


Test case without the triggering sequence: [seeds_750_not_mismatch.zip](https://github.com/user-attachments/files/23838595/seeds_750_not_mismatch.zip)



### Environment

XiangShan commit: https://github.com/OpenXiangShan/XiangShan/commit/10746d6aa982eb166f73cdb55c4334902ae604b9 (Wed Nov 26 17:46:13 2025)
Ready-to-run (NEMU, SPIKE) commit: c4e0350c0f686cfa206d5b47d80cfd730f39675a (Fri Nov 7 18:17:19 2025)
