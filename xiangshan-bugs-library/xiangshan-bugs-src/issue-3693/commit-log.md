# Commit Log
- Issue: #3693
- Issue URL: https://github.com/OpenXiangShan/XiangShan/pull/3693
- Issue state: closed
- Tested RTL commit: -
- Related PR: #3693
- PR URL: https://github.com/OpenXiangShan/XiangShan/pull/3693
- Changed files: 12
- Additions: 77
- Deletions: 96
...
index ccd75367ea8..5426192ce02 100644
...
index ca4fce1867b..e3cd34c3492 160000
--- a/difftest
+++ b/difftest
@@ -1 +1 @@
-Subproject commit ca4fce1867b23ebd9af27a4fa8627d2787bbee3a
+Subproject commit e3cd34c3492ce0c2dde0078ecce966d98d79c2e4
diff --git a/ready-to-run b/ready-to-run
index 6736823ec11..b5faebd9ce5 160000
--- a/ready-to-run
+++ b/ready-to-run
@@ -1 +1 @@
-Subproject commit 6736823ec116284d175d445494f680f9d7f00ece
+Subproject commit b5faebd9ce51cdc38400cdaba357e51c87703cbe
diff --git a/scripts/xiangshan.py b/scripts/xiangshan.py
index 0a31b5fa431..a420c12da39 100644
--- a/scripts/xiangshan.py
+++ b/scripts/xiangshan.py
@@ -427,7 +427,6 @@ def __get_ci_workloads(self, name):
...
index 11e2b715c43..58f77763009 100644
...
index 60a402b6147..a5f939e3346 100644
...
@@ -15,14 +15,12 @@ import xiangshan.AddrTransType
...
@@ -53,7 +51,6 @@ class MretEventModule(implicit p: Parameters) extends Module with CSREventBase {
...
@@ -63,7 +60,6 @@ class MretEventModule(implicit p: Parameters) extends Module with CSREventBase {
...
index a9ac4454ba0..498c9f4c234 100644
...
index f3b4eb469f7..5dfa0233ecb 100644
...
index 3eac6af530e..21e462a84e1 100644
...
-    tcontrol,
     ...
     dpc,
     dscratch0,
@@ -126,7 +122,7 @@ class Tdata1Bundle extends CSRBundle{
...
@@ -138,9 +134,9 @@ class Tdata1Bundle extends CSRBundle{
...
@@ -148,37 +144,39 @@ class Tdata1Bundle extends CSRBundle{
   }
 }
...
@@ -260,15 +258,8 @@ class Tdata2Bundle extends OneFieldBundle
...
index 555c2664ed6..5fd1056d748 100644
...
@@ -547,7 +547,6 @@ class MisaBundle extends CSRBundle {
...
index 056ca11360b..089443e1881 100644
