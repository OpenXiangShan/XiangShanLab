# Commit Log
- Issue: #5019
- Issue URL: https://github.com/OpenXiangShan/XiangShan/pull/5019
- Issue state: closed
- Tested RTL commit: -
- Related PR: #5019
- PR URL: https://github.com/OpenXiangShan/XiangShan/pull/5019
- Changed files: 1
- Additions: 3
- Deletions: 1
...
@@ -147,6 +148,7 @@ class IBufOutEntry(implicit p: Parameters) extends IBufferBundle {
...
@@ -170,7 +172,7 @@ class IBufOutEntry(implicit p: Parameters) extends IBufferBundle {
