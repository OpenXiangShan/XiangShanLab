# Commit Log
- Issue: #6102
- Issue URL: https://github.com/OpenXiangShan/XiangShan/pull/6102
- Issue state: closed
- Tested RTL commit: -
- Related PR: #6102
- PR URL: https://github.com/OpenXiangShan/XiangShan/pull/6102
- Changed files: 1
- Additions: 80
- Deletions: 28
...
index e62c2631331..bd0a6d8e1f5 100644
...
@@ -253,7 +253,11 @@ class MLPReqFilterBundle(implicit p: Parameters) extends XSBundle with HasL1Pref
   }
...
@@ -261,16 +265,16 @@ class MLPReqFilterBundle(implicit p: Parameters) extends XSBundle with HasL1Pref
...
@@ -653,6 +657,10 @@ class MutiLevelPrefetchFilter(implicit p: Parameters) extends XSModule with HasL
...
@@ -663,28 +671,32 @@ class MutiLevelPrefetchFilter(implicit p: Parameters) extends XSModule with HasL
...
@@ -699,30 +711,62 @@ class MutiLevelPrefetchFilter(implicit p: Parameters) extends XSModule with HasL
...
@@ -750,24 +794,32 @@ class MutiLevelPrefetchFilter(implicit p: Parameters) extends XSModule with HasL
