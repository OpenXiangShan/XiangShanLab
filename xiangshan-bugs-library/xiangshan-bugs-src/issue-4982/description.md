...
[BOT] REFs report different exception causes at 0x80000000

## Basic Information

- Testcase: `57f10079a3531b72c40b3e62fa31a374`
- NOOP Commit: `5adaa47ba55b0b877063612d991a1fd250c741a5`
- AI Analysis (Possible Root Cause):
The discrepancy arises because NEMU triggers an instruction access fault (mcause=1) due to PMA configuration marking 0x80000000 as non-executable, while Spike correctly generates an illegal instruction exception (mcause=2) for the invalid CSR 0x7c2 access. The RISC-V specification requires non-existent CSR accesses to cause illegal instruction exceptions after successful fetch; NEMU's PMA check failure (cfg=0x0f with reserved napat=11 in entry 4) prevents instruction execution, indicating a test environment misconfiguration or PMA implementation bug in NEMU, whereas Spike's behavior aligns with the expected exception semantics for the csrrw instruction.

## NEMU Diff

- Commit: `bbeddeac1d589852ccac9fb99cdcb1477e25b97e`
- Command: `./build/emu -i ./errors/57f10079a3531b72c40b3e62fa31a374 --max-cycles 10000 --diff /home/xuyinan/xs2/NEMU/build/riscv64-nemu-interpreter-so`
- Return Code: `1`
### NEMU stdout
```
...
The image is ./errors/57f10079a3531b72c40b3e62fa31a374
...
[03] commit pc 0000000080000000 inst 7c2c1373 wen 1 dst 06 data 186f0b080b0b0b0f idx 003 csrrw   t1, unknown_7c2, s8
[04] exception pc 0000000080000004 inst 00000000 cause 0000000000000002 c.unimp <--

==============  REF Regs  ==============
---------------- Intger Registers ----------------
  $0: 0x0000000000000000   ra: 0x0000000000000000   sp: 0x0000000000000000   gp: 0x0000000000000000 
  tp: 0x0000000000000000   t0: 0x0000000080000000   t1: 0x186f0b080b0b0b0f   t2: 0x0000000000000000 
...
pc: 0x0000000000000000  privilege mode: M (mode: 3  v: 0  debug: 0)
   ...
   hstatus: 0x0000000200000000  mnstatus: 0x0000000000000008
    mcause: 0x0000000000000001      mepc: 0x0000000080000004     mtval: 0x0000000080000004
...
pma: 16 entries active, details:
 ...
 8: cfg:0x00 addr:0x000000000e008400| 9: cfg:0x00 addr:0x000000000e008800
10: cfg:0x00 addr:0x000000000e400000|11: cfg:0x00 addr:0x000000000e400800
12: cfg:0x00 addr:0x000000000e800000|13: cfg:0x00 addr:0x0000000020000000
14: cfg:0x00 addr:0x0000020000000000|15: cfg:0x00 addr:0x00001fffffffffff
---------------- Vector Registers ----------------
...
privilegeMode: 3
  mtval different at pc = 0x0080000000, right= 0x0000000080000004, wrong = 0x0000000000000000
 mcause different at pc = 0x0080000000, right= 0x0000000000000001, wrong = 0x0000000000000002
Core 0: [31mABORT at pc = 0x80000012
[0m[35mCore-0 instrCnt = 4, cycleCnt = 4,156, IPC = 0.000962
[0mSimMemory: img_size 0, req_all 80, req_in_range 0
[34mSeed=0 Guest cycle spent: 4,160 (this will be different from cycleCnt if emu loads a snapshot)
[0m[34mHost time spent: 1,382ms
[0m
```
...
- Command: `./build/emu -i ./errors/57f10079a3531b72c40b3e62fa31a374 --max-cycles 10000 --diff /home/xuyinan/xs2/riscv-isa-sim/difftest/build/riscv64-spike-so`
- Return Code: `1`
### Spike stdout
```
emu compiled at Aug 25 2025, 19:57:26
...
zero: 0x0000000000000000   ra: 0x0000000000000000   sp: 0x0000000000000000   gp: 0x0000000000000000 
 ...
 fs8: 0xdc05d41ba91a6f1c  fs9: 0xe88ee5eef3674f19 fs10: 0x0000000000000000 fs11: 0xb1b119ca0bbd1a9b 
 ft8: 0xdc536ea7ee9bb03d  ft9: 0x8e0844084359ba56 ft10: 0xeab2f59456a27122 ft11: 0x847591c49bc71b70 
pc: 0x0000000000000000 mstatus: 0x0000040a00001800 mcause: 0x0000000000000002 mepc: 0x0000000080000000
...
mideleg: 0x0000000000001444 medeleg: 0x0000000000000000
mtval: 0x000000007c2c1373 stval: 0x0000000000000000 mtvec: 0x0000000000000000 stvec: 0x0000000000000000
privilege mode:3
 0: cfg:0x00 addr:0x0000000000000000 |  1: cfg:0x00 addr:0x0000000000000000
 2: cfg:0x00 addr:0x0000000000000000 |  3: cfg:0x00 addr:0x0000000000000000
 4: cfg:0x00 addr:0x0000000000000000 |  5: cfg:0x00 addr:0x0000000000000000
...
14: cfg:0x00 addr:0x0000000000000000 | 15: cfg:0x00 addr:0x0000000000000000
privilegeMode: 3
     t1 different at pc = 0x0080000000, right= 0x0000000000000000, wrong = 0x186f0b080b0b0b0f
mstatus different at pc = 0x0080000000, right= 0x0000040a00001800, wrong = 0x0000000a00000000
   mepc different at pc = 0x0080000000, right= 0x0000000080000000, wrong = 0x0000000000000000
  mtval different at pc = 0x0080000000, right= 0x000000007c2c1373, wrong = 0x0000000000000000
 mcause different at pc = 0x0080000000, right= 0x0000000000000002, wrong = 0x0000000000000000
Core 0: [31mABORT at pc = 0xfffeb4daa5c54916
[0m[35mCore-0 instrCnt = 4, cycleCnt = 4,147, IPC = 0.000965
[0mSimMemory: img_size 0, req_all 80, req_in_range 0
[34mSeed=0 Guest cycle spent: 4,151 (this will be different from cycleCnt if emu loads a snapshot)
[0m[34mHost time spent: 1,691ms
[0m
```
...
[57f10079a3531b72c40b3e62fa31a374.zip](https://github.com/user-attachments/files/22001988/57f10079a3531b72c40b3e62fa31a374.zip)
[reasoning.txt](https://github.com/user-attachments/files/22001989/reasoning.txt)
