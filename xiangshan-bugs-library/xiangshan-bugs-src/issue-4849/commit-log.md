# Commit Log
- Issue: #4849
- Issue URL: https://github.com/OpenXiangShan/XiangShan/pull/4849
- Issue state: closed
- Tested RTL commit: -
- Related PR: #4849
- PR URL: https://github.com/OpenXiangShan/XiangShan/pull/4849
- Changed files: 10
- Additions: 943
- Deletions: 615
...
- `src/main/scala/xiangshan/frontend/ifu/Abstracts.scala`
...
- `src/main/scala/xiangshan/frontend/ifu/Parameters.scala`
- `src/main/scala/xiangshan/frontend/ifu/PreDecode.scala`
...
index d0f259f18aa..d6053beb563 100644
--- a/src/main/scala/xiangshan/Parameters.scala
+++ b/src/main/scala/xiangshan/Parameters.scala
@@ -124,6 +124,7 @@ case class XSCoreParameters
...
+  IBufEnqWidth: Int = 16,
   ...
   DecodeWidth: Int = 6,
   RenameWidth: Int = 6,
@@ -700,6 +701,7 @@ trait HasXSParameter {
...
index 60b42927f30..576e45a3ec3 100644
...
diff --git a/src/main/scala/xiangshan/frontend/ifu/Abstracts.scala b/src/main/scala/xiangshan/frontend/ifu/Abstracts.scala
index 0f08a13d211..354767da1b7 100644
...
index c18356b5ed3..1aa3f1e81b5 100644
...
@@ -68,3 +88,9 @@ class IfuWbToFtqDB(implicit p: Parameters) extends IfuBundle {
...
index 031cc234826..3d699ca6928 100644
...
@@ -47,12 +48,14 @@ import xiangshan.frontend.ExceptionType
...
@@ -63,7 +66,7 @@ class Ifu(implicit p: Parameters) extends IfuModule
...
+    with IfuHelper
     ...
     with HasPerfEvents
     with HasTlbConst {
@@ -104,12 +107,12 @@ class Ifu(implicit p: Parameters) extends IfuModule
...
@@ -119,9 +122,9 @@ class Ifu(implicit p: Parameters) extends IfuModule
...
@@ -203,19 +206,22 @@ class Ifu(implicit p: Parameters) extends IfuModule
...
@@ -225,11 +231,8 @@ class Ifu(implicit p: Parameters) extends IfuModule
...
+  XSPerfAccumulate("fetch_flush_wb_redirect", wbRedirect.valid)
   ...
   /* *****************************************************************************
@@ -246,50 +249,26 @@ class Ifu(implicit p: Parameters) extends IfuModule
...
@@ -298,12 +277,27 @@ class Ifu(implicit p: Parameters) extends IfuModule
...
@@ -346,62 +340,201 @@ class Ifu(implicit p: Parameters) extends IfuModule
...
-  }
    ...
    * Explanation:
@@ -411,18 +544,18 @@ class Ifu(implicit p: Parameters) extends IfuModule
...
@@ -431,33 +564,64 @@ class Ifu(implicit p: Parameters) extends IfuModule
...
@@ -469,89 +633,73 @@ class Ifu(implicit p: Parameters) extends IfuModule
    * ***************************************************************************** */
...
@@ -598,19 +746,19 @@ class Ifu(implicit p: Parameters) extends IfuModule
...
@@ -619,46 +767,46 @@ class Ifu(implicit p: Parameters) extends IfuModule
...
@@ -679,7 +827,7 @@ class Ifu(implicit p: Parameters) extends IfuModule
...
+        val needResend = !respIsRVC && s4_pAddr(0)(2, 1) === 3.U && exception.isNone
         ...
         mmioIsRvc     := respIsRVC
@@ -739,7 +887,7 @@ class Ifu(implicit p: Parameters) extends IfuModule
...
@@ -750,19 +898,19 @@ class Ifu(implicit p: Parameters) extends IfuModule
...
@@ -778,103 +926,84 @@ class Ifu(implicit p: Parameters) extends IfuModule
...
@@ -888,52 +1017,56 @@ class Ifu(implicit p: Parameters) extends IfuModule
   }
...
@@ -946,7 +1079,7 @@ class Ifu(implicit p: Parameters) extends IfuModule
...
@@ -955,8 +1088,11 @@ class Ifu(implicit p: Parameters) extends IfuModule
...
+  mmioRedirect.prevIBufEnqPtr := s4_prevIBufEnqPtr
   ...
   /* *****************************************************************************
@@ -965,86 +1101,66 @@ class Ifu(implicit p: Parameters) extends IfuModule
...
@@ -1069,40 +1185,40 @@ class Ifu(implicit p: Parameters) extends IfuModule
   )
...
@@ -1120,10 +1236,10 @@ class Ifu(implicit p: Parameters) extends IfuModule
...
diff --git a/src/main/scala/xiangshan/frontend/ifu/Parameters.scala b/src/main/scala/xiangshan/frontend/ifu/Parameters.scala
new file mode 100644
index 00000000000..2c98e4944b9
--- /dev/null
...
+  def PcCutPoint: Int = (VAddrBits / 4) - 1
+}
diff --git a/src/main/scala/xiangshan/frontend/ifu/PreDecode.scala b/src/main/scala/xiangshan/frontend/ifu/PreDecode.scala
index 9d61591d060..f2736a53902 100644
--- a/src/main/scala/xiangshan/frontend/ifu/PreDecode.scala
+++ b/src/main/scala/xiangshan/frontend/ifu/PreDecode.scala
@@ -23,16 +23,15 @@ import utility.XSError
 import xiangshan.frontend.PreDecodeInfo
 import xiangshan.frontend.PrunedAddr
...
@@ -42,56 +41,18 @@ class PreDecode(implicit p: Parameters) extends IfuModule with PreDecodeHelper {
   }
...
@@ -102,87 +63,10 @@ class PreDecode(implicit p: Parameters) extends IfuModule with PreDecodeHelper {
...
@@ -58,12 +75,24 @@ class PredChecker(implicit p: Parameters) extends IfuModule {
...
@@ -74,20 +103,29 @@ class PredChecker(implicit p: Parameters) extends IfuModule {
...
+    instrValid.asUInt & (Fill(PredictWidth, !needRemask) | Fill(PredictWidth, 1.U(1.W)) >> ~remaskIdx)
   ...
   require(
     isPow2(PredictWidth),
@@ -95,33 +133,63 @@ class PredChecker(implicit p: Parameters) extends IfuModule {
...
@@ -130,14 +198,32 @@ class PredChecker(implicit p: Parameters) extends IfuModule {
...
+  io.resp.stage2Out.twoFetchFaultType.zipWithIndex.foreach { case (faultType, i) =>
     faultType := MuxCase(
       ...
       Seq(
@@ -151,13 +237,42 @@ class PredChecker(implicit p: Parameters) extends IfuModule {
     )
   }
