# Commit Log
- Issue: #4725
- Issue URL: https://github.com/OpenXiangShan/XiangShan/pull/4725
- Issue state: closed
- Tested RTL commit: -
- Related PR: #4725
- PR URL: https://github.com/OpenXiangShan/XiangShan/pull/4725
- Changed files: 5
- Additions: 107
- Deletions: 84
...
index d9a3008ad31..694e67c8772 100644
...
index e3f4313cae6..48002a219f6 100644
--- a/src/main/scala/xiangshan/frontend/icache/ICacheImp.scala
+++ b/src/main/scala/xiangshan/frontend/icache/ICacheImp.scala
@@ -229,8 +229,8 @@ class ICacheImp(outer: ICache) extends LazyModuleImp(outer) with HasICacheParame
...
index 002455e4659..3afc25ab89c 100644
...
@@ -62,8 +62,9 @@ class ICacheMainPipe(implicit p: Parameters) extends ICacheModule
...
@@ -243,9 +244,9 @@ class ICacheMainPipe(implicit p: Parameters) extends ICacheModule
   )
...
@@ -490,31 +491,29 @@ class ICacheMainPipe(implicit p: Parameters) extends ICacheModule
     }
   }
...
index cd886001a1f..8464b9facbf 100644
...
@@ -250,15 +251,29 @@ class ICacheMissUnit(edge: TLEdgeOut)(implicit p: Parameters) extends ICacheModu
...
index cee19711fdf..beb40009383 100644
