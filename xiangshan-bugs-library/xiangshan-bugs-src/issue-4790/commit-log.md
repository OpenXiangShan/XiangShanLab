# Commit Log
- Issue: #4790
- Issue URL: https://github.com/OpenXiangShan/XiangShan/pull/4790
- Issue state: closed
- Tested RTL commit: -
- Related PR: #4790
- PR URL: https://github.com/OpenXiangShan/XiangShan/pull/4790
- Changed files: 12
- Additions: 558
- Deletions: 390
...
index 0bb999d8bf6..a1cc2e0445a 100644
...
index 60782f17a83..d0f259f18aa 100644
...
@@ -577,6 +577,13 @@ trait HasXSParameter {
...
index e687c8b0c9b..4d2e86fd93f 100644
--- a/src/main/scala/xiangshan/cache/mmu/Repeater.scala
+++ b/src/main/scala/xiangshan/cache/mmu/Repeater.scala
@@ -206,34 +206,15 @@ class PTWFilterEntry(Width: Int, Size: Int, hasHint: Boolean = false)(implicit p
...
@@ -349,7 +330,7 @@ class PTWNewFilter(Width: Int, Size: Int, FenceDelay: Int)(implicit p: Parameter
...
@@ -359,15 +340,15 @@ class PTWNewFilter(Width: Int, Size: Int, FenceDelay: Int)(implicit p: Parameter
   })
...
@@ -395,11 +376,11 @@ class PTWNewFilter(Width: Int, Size: Int, FenceDelay: Int)(implicit p: Parameter
...
@@ -414,11 +395,11 @@ class PTWNewFilter(Width: Int, Size: Int, FenceDelay: Int)(implicit p: Parameter
...
index 19bee84a186..8186d16a36f 100644
...
index 99cea05c7c0..d8ea8f14bfd 100644
...
@@ -265,12 +265,11 @@ class MemBlockInlined()(implicit p: Parameters) extends LazyModule
...
@@ -429,74 +429,6 @@ class MemBlockInlinedImp(outer: MemBlockInlined) extends LazyModuleImp(outer)
...
@@ -549,62 +481,6 @@ class MemBlockInlinedImp(outer: MemBlockInlined) extends LazyModuleImp(outer)
...
@@ -621,41 +497,6 @@ class MemBlockInlinedImp(outer: MemBlockInlined) extends LazyModuleImp(outer)
...
@@ -676,20 +517,45 @@ class MemBlockInlinedImp(outer: MemBlockInlined) extends LazyModuleImp(outer)
     Seq()
   }
...
@@ -710,7 +576,7 @@ class MemBlockInlinedImp(outer: MemBlockInlined) extends LazyModuleImp(outer)
   } else {
...
@@ -765,9 +631,9 @@ class MemBlockInlinedImp(outer: MemBlockInlined) extends LazyModuleImp(outer)
...
@@ -789,6 +655,111 @@ class MemBlockInlinedImp(outer: MemBlockInlined) extends LazyModuleImp(outer)
...
@@ -943,28 +914,6 @@ class MemBlockInlinedImp(outer: MemBlockInlined) extends LazyModuleImp(outer)
...
@@ -1082,34 +1031,6 @@ class MemBlockInlinedImp(outer: MemBlockInlined) extends LazyModuleImp(outer)
...
-    })
     ...
     // load to load fast forward: load(i) prefers data(i)
     val l2l_fwd_out = loadUnits.map(_.io.l2l_fwd_out) ++ hybridUnits.map(_.io.ldu_io.l2l_fwd_out)
@@ -1203,32 +1124,6 @@ class MemBlockInlinedImp(outer: MemBlockInlined) extends LazyModuleImp(outer)
...
@@ -1249,7 +1144,7 @@ class MemBlockInlinedImp(outer: MemBlockInlined) extends LazyModuleImp(outer)
...
+    stu.io.pmp          <> pmp_check(TlbStartVec(dtlb_st_idx) + i).resp
     ...
     // -------------------------
     // Store Triggers
@@ -1306,25 +1201,6 @@ class MemBlockInlinedImp(outer: MemBlockInlined) extends LazyModuleImp(outer)
...
@@ -2028,8 +1904,7 @@ class MemBlockInlinedImp(outer: MemBlockInlined) extends LazyModuleImp(outer)
         ModuleNode(pmp)
       )
...
index 8b71b842052..2b35c85b78f 100644
...
index a775d278d7d..79f67aeefb0 100644
...
+    val s3_ptr_chasing = Output(Bool()) // provide right pc for hw prefetch
     ...
     // Load fast replay path
     val fast_rep_in  = Flipped(Decoupled(new LqWriteBundle))
@@ -1441,40 +1441,26 @@ class LoadUnit(implicit p: Parameters) extends XSModule
...
index bcc155848ac..6be68b7ce78 100644
...
index 52108012214..d64d018c879 100644
...
@@ -15,6 +15,11 @@ import xiangshan.mem.L1PrefetchSource
...
@@ -374,7 +379,7 @@ class MutiLevelPrefetchFilter(implicit p: Parameters) extends XSModule with HasL
     val pmp_resp = Flipped(new PMPRespBundle())
     val l1_req = DecoupledIO(new L1PrefetchReq())
...
@@ -423,7 +428,7 @@ class MutiLevelPrefetchFilter(implicit p: Parameters) extends XSModule with HasL
...
@@ -812,11 +817,15 @@ class MutiLevelPrefetchFilter(implicit p: Parameters) extends XSModule with HasL
...
@@ -917,7 +926,7 @@ class L1Prefetcher(implicit p: Parameters) extends BasePrefecher with HasStreamP
...
index 36af36ea983..7703f339eb8 100644
