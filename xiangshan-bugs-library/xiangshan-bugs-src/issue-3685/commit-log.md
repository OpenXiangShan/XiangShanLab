# Commit Log
- Issue: #3685
- Issue URL: https://github.com/OpenXiangShan/XiangShan/pull/3685
- Issue state: closed
- Tested RTL commit: -
- Related PR: #3685
- PR URL: https://github.com/OpenXiangShan/XiangShan/pull/3685
- Changed files: 1
- Additions: 4
- Deletions: 21
...
index 56493494ba3..d6fbeb622cf 100644
--- a/src/main/scala/xiangshan/cache/mmu/MMUBundle.scala
+++ b/src/main/scala/xiangshan/cache/mmu/MMUBundle.scala
@@ -297,16 +297,7 @@ class TlbSectorEntry(pageNormal: Boolean, pageSuper: Boolean)(implicit p: Parame
...
@@ -1257,18 +1248,10 @@ class PtwRespS2(implicit p: Parameters) extends PtwBundle {
