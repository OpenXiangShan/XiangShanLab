# Commit Log
- Issue: #3437
- Issue URL: https://github.com/OpenXiangShan/XiangShan/pull/3437
- Issue state: closed
- Tested RTL commit: -
- Related PR: #3437
- PR URL: https://github.com/OpenXiangShan/XiangShan/pull/3437
- Changed files: 2
- Additions: 11
- Deletions: 28
...
index ac8891a7428..680a11cd75e 100644
...
index a283b35efcf..9c118cda39a 100644
--- a/src/main/scala/xiangshan/frontend/IBuffer.scala
+++ b/src/main/scala/xiangshan/frontend/IBuffer.scala
@@ -359,11 +359,9 @@ class IBuffer(implicit p: Parameters) extends XSModule with HasCircularQueuePtrH
   }
...
@@ -431,33 +429,18 @@ class IBuffer(implicit p: Parameters) extends XSModule with HasCircularQueuePtrH
