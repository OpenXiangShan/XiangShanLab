# Commit Log
- Issue: #4346
- Issue URL: https://github.com/OpenXiangShan/XiangShan/pull/4346
- Issue state: closed
- Tested RTL commit: -
- Related PR: #4346
- PR URL: https://github.com/OpenXiangShan/XiangShan/pull/4346
- Changed files: 2
- Additions: 53
- Deletions: 9

## Files
- `src/main/scala/xiangshan/backend/fu/util/Trigger.scala`
- `src/test/scala/xiangshan/frontend/FrontTrigger.scala`

## Diff
```diff
diff --git a/src/main/scala/xiangshan/backend/fu/util/Trigger.scala b/src/main/scala/xiangshan/backend/fu/util/Trigger.scala
index b51c996df8c..3f27b8d05f6 100644
...
diff --git a/src/test/scala/xiangshan/frontend/FrontTrigger.scala b/src/test/scala/xiangshan/frontend/FrontTrigger.scala
new file mode 100644
index 00000000000..17b4e26205d
--- /dev/null
+++ b/src/test/scala/xiangshan/frontend/FrontTrigger.scala
@@ -0,0 +1,47 @@
