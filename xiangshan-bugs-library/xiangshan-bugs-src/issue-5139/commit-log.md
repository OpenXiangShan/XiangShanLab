# Commit Log
- Issue: #5139
- Issue URL: https://github.com/OpenXiangShan/XiangShan/pull/5139
- Issue state: closed
- Tested RTL commit: -
- Related PR: #5139
- PR URL: https://github.com/OpenXiangShan/XiangShan/pull/5139
- Changed files: 2
- Additions: 24
- Deletions: 24
...
index 81c92486a50..381376eb8d2 100644
...
index ae2bff97f18..53eaca821ea 100644
...
-
   updateData := MuxCase(
     ...
     Seq(
@@ -110,12 +111,12 @@ class Phr(implicit p: Parameters) extends PhrModule with HasPhrParameters with H
...
@@ -134,18 +135,18 @@ class Phr(implicit p: Parameters) extends PhrModule with HasPhrParameters with H
    */
...
@@ -249,9 +248,10 @@ class Phr(implicit p: Parameters) extends PhrModule with HasPhrParameters with H
