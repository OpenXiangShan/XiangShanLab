# Commit Log
- Issue: #5862
- Issue URL: https://github.com/OpenXiangShan/XiangShan/pull/5862
- Issue state: closed
- Tested RTL commit: -
- Related PR: #5862
- PR URL: https://github.com/OpenXiangShan/XiangShan/pull/5862
- Changed files: 16
- Additions: 62
- Deletions: 5
...
index e47febc8b4a..3a076f72e83 100644
...
index 2b528ca0bbe..daee1f51497 100644
...
index 8dce137777e..81d64873ade 100644
...
index 55337bfc45a..6fde05ab113 100644
...
+  EnableResetMtvec: Option[Boolean],
 ...
 object YamlParser {
@@ -128,6 +129,11 @@ object YamlParser {
...
index 1d5cb55ac03..26883502b50 100644
...
index 63a5e08893f..7d97fac95a8 100644
...
@@ -597,6 +598,7 @@ trait HasXSParameter {
   val fLen = 64
...
index 349715703b4..a2902a33037 100644
...
index 725fcb2c5dd..6f36bbfd584 100644
--- a/src/main/scala/xiangshan/XSTile.scala
+++ b/src/main/scala/xiangshan/XSTile.scala
@@ -106,6 +106,7 @@ class XSTile()(implicit p: Parameters) extends LazyModule
...
@@ -145,6 +147,7 @@ class XSTile()(implicit p: Parameters) extends LazyModule
...
index 3857f19a2ec..7178612870a 100644
...
index e27454ee729..a60f5133d19 100644
...
index bbff2c7b70f..c8323f5b211 100644
...
index 946ae3f78f4..8e37acc2235 100644
...
index 8dabd68a47c..d33125e9fab 100644
...
index 36a77fe5ce0..e6cd8a2e706 100644
--- a/src/main/scala/xiangshan/mem/MemBlock.scala
+++ b/src/main/scala/xiangshan/mem/MemBlock.scala
@@ -339,6 +339,7 @@ class MemBlockInlinedImp(outer: MemBlockInlined) extends LazyModuleImp(outer)
...
@@ -2017,6 +2018,7 @@ class MemBlockInlinedImp(outer: MemBlockInlined) extends LazyModuleImp(outer)
...
index 2f1ca4b8e7d..2c554bcd834 100644
--- a/src/test/scala/top/SimTop.scala
+++ b/src/test/scala/top/SimTop.scala
@@ -65,6 +65,7 @@ class XiangShanSim(implicit p: Parameters) extends Module with HasDiffTestInterf
   soc.io.pll0_lock := true.B
   soc.io.cacheable_check := DontCare
   soc.io.riscv_rst_vec.foreach(_ := 0x10000000L.U)
+  soc.io.riscv_rst_mtvec.foreach{vec => vec.map(x => x := 0.U.asTypeOf(x))}
