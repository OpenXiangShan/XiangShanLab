# Commit Log
- Issue: #3290
- Issue URL: https://github.com/OpenXiangShan/XiangShan/pull/3290
- Issue state: closed
- Tested RTL commit: -
- Related PR: #3290
- PR URL: https://github.com/OpenXiangShan/XiangShan/pull/3290
- Changed files: 22
- Additions: 950
- Deletions: 37
...
- `src/main/scala/xiangshan/backend/datapath/DataSource.scala`
...
- `src/main/scala/xiangshan/backend/regcache/AgeDetector.scala`
- `src/main/scala/xiangshan/backend/regcache/RegCache.scala`
- `src/main/scala/xiangshan/backend/regcache/RegCacheAgeTimer.scala`
- `src/main/scala/xiangshan/backend/regcache/RegCacheDataModule.scala`
- `src/main/scala/xiangshan/backend/regcache/RegCacheTagModule.scala`
...
index e3b4d12f198..e4a86f99b17 100644
...
@@ -359,24 +361,27 @@ case class XSCoreParameters
...
@@ -444,19 +449,19 @@ case class XSCoreParameters
...
@@ -465,10 +470,10 @@ case class XSCoreParameters
...
@@ -687,6 +692,10 @@ trait HasXSParameter {
...
index 0690fc2f7a8..19332450024 100644
...
@@ -346,6 +348,7 @@ class BackendImp(override val wrapper: Backend)(implicit p: Parameters) extends
...
@@ -360,6 +363,7 @@ class BackendImp(override val wrapper: Backend)(implicit p: Parameters) extends
...
@@ -370,6 +374,7 @@ class BackendImp(override val wrapper: Backend)(implicit p: Parameters) extends
   )
...
index 4b220581d5a..e8a371a517c 100644
...
@@ -322,6 +323,29 @@ case class BackendParams(
...
index fb8107ec534..8ebb01b937f 100644
...
@@ -65,8 +75,11 @@ class BypassNetwork()(implicit p: Parameters, params: BackendParams) extends XSM
...
index 1eb83789848..a4d51453885 100644
...
@@ -410,6 +411,49 @@ class DataPathImp(override val wrapper: DataPath)(implicit p: Parameters, params
...
@@ -729,6 +773,27 @@ class DataPathImp(override val wrapper: DataPath)(implicit p: Parameters, params
...
@@ -791,6 +856,20 @@ class DataPathIO()(implicit p: Parameters, params: BackendParams) extends XSBund
...
diff --git a/src/main/scala/xiangshan/backend/datapath/DataSource.scala b/src/main/scala/xiangshan/backend/datapath/DataSource.scala
index e54e4345796..b72a56ba630 100644
--- a/src/main/scala/xiangshan/backend/datapath/DataSource.scala
+++ b/src/main/scala/xiangshan/backend/datapath/DataSource.scala
@@ -9,6 +9,8 @@ class DataSource extends Bundle {
...
@@ -69,6 +70,10 @@ class Dispatch2Iq(val schdBlockParams : SchdBlockParams)(implicit p: Parameters)
...
@@ -96,6 +101,7 @@ abstract class Dispatch2IqImp(override val wrapper: Dispatch2Iq)(implicit p: Par
...
@@ -106,6 +112,7 @@ abstract class Dispatch2IqImp(override val wrapper: Dispatch2Iq)(implicit p: Par
...
@@ -126,6 +133,7 @@ abstract class Dispatch2IqImp(override val wrapper: Dispatch2Iq)(implicit p: Par
...
@@ -142,6 +150,8 @@ abstract class Dispatch2IqImp(override val wrapper: Dispatch2Iq)(implicit p: Par
...
@@ -207,6 +217,14 @@ abstract class Dispatch2IqImp(override val wrapper: Dispatch2Iq)(implicit p: Par
...
@@ -245,6 +263,18 @@ abstract class Dispatch2IqImp(override val wrapper: Dispatch2Iq)(implicit p: Par
         }
     }
...
index 51011b02d77..22985132801 100644
...
@@ -335,6 +338,20 @@ object EntryBundles extends HasCircularQueuePtrHelper {
       } else {
...
@@ -363,6 +380,7 @@ object EntryBundles extends HasCircularQueuePtrHelper {
...
@@ -372,10 +390,14 @@ object EntryBundles extends HasCircularQueuePtrHelper {
                                                             } else {
                                                               MuxCase(status.srcStatus(srcIdx).dataSources.value, Seq(
...
index e1063a0f46e..e32a54e334f 100644
...
index 9a7cfd696ba..80b65452862 100644
...
@@ -770,20 +774,15 @@ class IssueQueueImp(override val wrapper: IssueQueue)(implicit p: Parameters, va
...
@@ -1078,6 +1077,7 @@ class IssueQueueMemAddrImp(override val wrapper: IssueQueue)(implicit p: Paramet
...
index 9729383583c..46e510f45db 100644
...
@@ -123,6 +123,10 @@ case class SchdBlockParams(
     backendParam = param
   }
...
index 66f1807734a..f7f1077a46a 100644
...
@@ -96,6 +97,8 @@ class SchedulerIO()(implicit params: SchdBlockParams, p: Parameters) extends XSB
     val og0Cancel = Input(ExuVec())
...
@@ -182,6 +185,12 @@ abstract class SchedulerImpBase(wrapper: Scheduler)(implicit params: SchdBlockPa
     case _ => None
   }
...
@@ -190,6 +199,7 @@ abstract class SchedulerImpBase(wrapper: Scheduler)(implicit params: SchdBlockPa
...
+    dp2iq.readRCTagTableState.foreach(_ <> rcTagTable.get.io.readPorts)
   ...
   intBusyTable match {
@@ -272,6 +282,18 @@ abstract class SchedulerImpBase(wrapper: Scheduler)(implicit params: SchdBlockPa
     case None =>
   }
...
@@ -409,6 +431,20 @@ abstract class SchedulerImpBase(wrapper: Scheduler)(implicit params: SchdBlockPa
     }
...
+    println(s"[Scheduler] iqReplaceRCIdxVec: ${iqReplaceRCIdxVec.size}")
   ...
   // perfEvent
@@ -582,10 +618,12 @@ class SchedulerMemImp(override val wrapper: Scheduler)(implicit params: SchdBloc
...
+    stdIQEnq.bits.regCacheIdx(0) := staIQEnq.bits.regCacheIdx(stdIdx)
   ...
   vecMemIQs.foreach {
diff --git a/src/main/scala/xiangshan/backend/regcache/AgeDetector.scala b/src/main/scala/xiangshan/backend/regcache/AgeDetector.scala
new file mode 100644
index 00000000000..247623bfaec
--- /dev/null
+++ b/src/main/scala/xiangshan/backend/regcache/AgeDetector.scala
@@ -0,0 +1,79 @@
+/***************************************************************************************
...
diff --git a/src/main/scala/xiangshan/backend/regcache/RegCache.scala b/src/main/scala/xiangshan/backend/regcache/RegCache.scala
new file mode 100644
index 00000000000..6a37da00802
--- /dev/null
...
+     Output(UInt(RegCacheIdxWidth.W)))
+}
diff --git a/src/main/scala/xiangshan/backend/regcache/RegCacheAgeTimer.scala b/src/main/scala/xiangshan/backend/regcache/RegCacheAgeTimer.scala
new file mode 100644
index 00000000000..6e8a8e754d4
--- /dev/null
...
+  }
+}
diff --git a/src/main/scala/xiangshan/backend/regcache/RegCacheDataModule.scala b/src/main/scala/xiangshan/backend/regcache/RegCacheDataModule.scala
new file mode 100644
index 00000000000..04229312634
--- /dev/null
+++ b/src/main/scala/xiangshan/backend/regcache/RegCacheDataModule.scala
@@ -0,0 +1,91 @@
+/***************************************************************************************
+* Copyright (c) 2020-2021 Institute of Computing Technology, Chinese Academy of Sciences
+* Copyright (c) 2020-2021 Peng Cheng Laboratory
...
+  io.validInfo := v
+}
diff --git a/src/main/scala/xiangshan/backend/regcache/RegCacheTagModule.scala b/src/main/scala/xiangshan/backend/regcache/RegCacheTagModule.scala
new file mode 100644
index 00000000000..e4ddf86a8e7
--- /dev/null
+++ b/src/main/scala/xiangshan/backend/regcache/RegCacheTagModule.scala
@@ -0,0 +1,106 @@
+/***************************************************************************************
+* Copyright (c) 2020-2021 Institute of Computing Technology, Chinese Academy of Sciences
+* Copyright (c) 2020-2021 Peng Cheng Laboratory
...
index 17fc8b5ca47..ab02a1e0580 100644
