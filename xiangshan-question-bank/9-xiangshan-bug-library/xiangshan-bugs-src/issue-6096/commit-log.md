# Commit Log
- Issue: #6096
- Issue URL: https://github.com/OpenXiangShan/XiangShan/pull/6096
- Issue state: closed
- Tested RTL commit: -
- Related PR: #6096
- PR URL: https://github.com/OpenXiangShan/XiangShan/pull/6096
- Changed files: 1
- Additions: 6
- Deletions: 6

## Files
- `src/main/scala/xiangshan/backend/decode/opcode/Opcode.scala`

## Diff
```diff
diff --git a/src/main/scala/xiangshan/backend/decode/opcode/Opcode.scala b/src/main/scala/xiangshan/backend/decode/opcode/Opcode.scala
index 34f9bd96502..dc1437d5b26 100644
