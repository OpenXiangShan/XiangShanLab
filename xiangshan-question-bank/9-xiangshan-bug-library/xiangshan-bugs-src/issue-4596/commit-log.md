# Commit Log
- Issue: #4596
- Issue URL: https://github.com/OpenXiangShan/XiangShan/pull/4596
- Issue state: closed
- Tested RTL commit: -
- Related PR: #4596
- PR URL: https://github.com/OpenXiangShan/XiangShan/pull/4596
- Changed files: 1
- Additions: 20
- Deletions: 8
...
index ca7051e12a1..385c002b423 100644
--- a/src/main/scala/xiangshan/cache/mmu/PageTableWalker.scala
+++ b/src/main/scala/xiangshan/cache/mmu/PageTableWalker.scala
@@ -773,17 +773,28 @@ class LLPTW(implicit p: Parameters) extends XSModule with HasPtwConst with HasPe
...
@@ -803,7 +814,7 @@ class LLPTW(implicit p: Parameters) extends XSModule with HasPtwConst with HasPe
...
+    entries(enq_ptr).ppn := Mux(to_last_hptw_req || last_hptw_excp, last_hptw_req_ppn, io.in.bits.ppn)
     ...
     if (HasBitmapCheck) {
@@ -817,6 +828,7 @@ class LLPTW(implicit p: Parameters) extends XSModule with HasPtwConst with HasPe
