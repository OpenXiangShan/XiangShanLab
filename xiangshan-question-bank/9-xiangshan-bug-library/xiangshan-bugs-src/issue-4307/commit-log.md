# Commit Log
- Issue: #4307
- Issue URL: https://github.com/OpenXiangShan/XiangShan/pull/4307
- Issue state: closed
- Tested RTL commit: -
- Related PR: #4307
- PR URL: https://github.com/OpenXiangShan/XiangShan/pull/4307
- Changed files: 3
- Additions: 6
- Deletions: 3
...
index aa47bb2572c..e950eecf669 100644
...
@@ -67,6 +67,7 @@ class TrapEntryHSEventModule(implicit val p: Parameters) extends Module with CSR
...
@@ -131,7 +132,7 @@ class TrapEntryHSEventModule(implicit val p: Parameters) extends Module with CSR
...
index 1c69e078644..d58f896cc61 100644
...
@@ -65,6 +65,7 @@ class TrapEntryMEventModule(implicit val p: Parameters) extends Module with CSRE
   private val isHlsExcp      = isException && in.isHls
   private val fetchCrossPage = in.isCrossPageIPF
   private val isFetchMalAddr = in.isFetchMalAddr
+  private val isFetchMalAddrExcp = isException && isFetchMalAddr
   ...
   private val isLSGuestExcp    = isException && ExceptionNO.getLSGuestPageFault.map(_.U === highPrioTrapNO).reduce(_ || _)
@@ -118,7 +119,7 @@ class TrapEntryMEventModule(implicit val p: Parameters) extends Module with CSRE
...
index 8b72a740351..66629c42add 100644
