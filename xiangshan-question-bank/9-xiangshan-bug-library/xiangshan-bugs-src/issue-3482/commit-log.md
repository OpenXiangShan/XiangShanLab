# Commit Log
- Issue: #3482
- Issue URL: https://github.com/OpenXiangShan/XiangShan/pull/3482
- Issue state: closed
- Tested RTL commit: -
- Related PR: #3482
- PR URL: https://github.com/OpenXiangShan/XiangShan/pull/3482
- Changed files: 10
- Additions: 117
- Deletions: 69
...
- `src/main/scala/xiangshan/backend/datapath/Og2ForVector.scala`
...
index 3821487d1e8..076c05ca531 100644
--- a/src/main/scala/xiangshan/backend/Backend.scala
+++ b/src/main/scala/xiangshan/backend/Backend.scala
@@ -307,6 +307,7 @@ class BackendImp(override val wrapper: Backend)(implicit p: Parameters) extends
...
@@ -324,7 +325,7 @@ class BackendImp(override val wrapper: Backend)(implicit p: Parameters) extends
...
@@ -352,17 +353,32 @@ class BackendImp(override val wrapper: Backend)(implicit p: Parameters) extends
...
index 8697d5e92a7..56ecc35046a 100644
...
+          // hyu, lda and sta are uncertain at OG1 stage
           ...
           og1resp.bits.resp             := Mux(og1FailedVec2(iqIdx)(iuIdx),
             RespType.block,
diff --git a/src/main/scala/xiangshan/backend/datapath/Og2ForVector.scala b/src/main/scala/xiangshan/backend/datapath/Og2ForVector.scala
index 11970a7ff81..f9a85f25e82 100644
...
index 0f8335ce7a2..3fee5781ba4 100644
...
index 0ae5e675d94..7bc328f17fe 100644
...
index a89ed6e8528..d9dd65965fb 100644
...
@@ -204,6 +208,8 @@ case class IssueBlockParams(
...
index ccff6ac2547..203167207c2 100644
--- a/src/main/scala/xiangshan/backend/issue/IssueQueue.scala
+++ b/src/main/scala/xiangshan/backend/issue/IssueQueue.scala
@@ -49,7 +49,7 @@ class IssueQueueIO()(implicit p: Parameters, params: IssueBlockParams) extends X
...
@@ -322,7 +322,7 @@ class IssueQueueImp(override val wrapper: IssueQueue)(implicit p: Parameters, va
...
index 46e510f45db..a154de05d71 100644
...
@@ -91,6 +91,8 @@ case class SchdBlockParams(
...
index 8a120ff822b..47492aea3b3 100644
--- a/src/main/scala/xiangshan/backend/issue/Scheduler.scala
+++ b/src/main/scala/xiangshan/backend/issue/Scheduler.scala
@@ -132,7 +132,7 @@ class SchedulerIO()(implicit params: SchdBlockParams, p: Parameters) extends XSB
...
@@ -427,15 +427,17 @@ abstract class SchedulerImpBase(wrapper: Scheduler)(implicit params: SchdBlockPa
