# Commit Log
- Issue: #4422
- Issue URL: https://github.com/OpenXiangShan/XiangShan/pull/4422
- Issue state: closed
- Tested RTL commit: -
- Related PR: #4422
- PR URL: https://github.com/OpenXiangShan/XiangShan/pull/4422
- Changed files: 1
- Additions: 6
- Deletions: 6
...
index f542f663cb3..757dc7553f5 100644
...
@@ -172,11 +168,16 @@ class PTW()(implicit p: Parameters) extends XSModule with HasPtwConst with HasPe
   } else {
