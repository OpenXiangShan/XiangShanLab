# Commit Log
- Issue: #4979
- Issue URL: https://github.com/OpenXiangShan/XiangShan/pull/4979
- Issue state: closed
- Tested RTL commit: -
- Related PR: #4979
- PR URL: https://github.com/OpenXiangShan/XiangShan/pull/4979
- Changed files: 1
- Additions: 2
- Deletions: 1
...
index e8dee70914a..f46aecdb389 100644
...
@@ -50,6 +50,7 @@ class TrapEntryDEventModule(implicit val p: Parameters) extends Module with CSRE
...
@@ -88,7 +89,7 @@ class TrapEntryDEventModule(implicit val p: Parameters) extends Module with CSRE
