# Commit Log
- Issue: #5803
- Issue URL: https://github.com/OpenXiangShan/XiangShan/pull/5803
- Issue state: closed
- Tested RTL commit: -
- Related PR: #5803
- PR URL: https://github.com/OpenXiangShan/XiangShan/pull/5803
- Changed files: 10
- Additions: 170
- Deletions: 68
...
## Diff
```diff
diff --git a/scripts/top-down/configs.py b/scripts/top-down/configs.py
index 63d62fe3904..b92926ca2df 100644
...
index 672b3ad89d4..c86852ac6a7 100644
--- a/src/main/scala/xiangshan/backend/Backend.scala
+++ b/src/main/scala/xiangshan/backend/Backend.scala
@@ -515,6 +515,8 @@ class BackendInlinedImp(override val wrapper: BackendInlined)(implicit p: Parame
...
index a4d5fd06c34..3f7c1319e2b 100644
--- a/src/main/scala/xiangshan/backend/CtrlBlock.scala
+++ b/src/main/scala/xiangshan/backend/CtrlBlock.scala
@@ -40,6 +40,7 @@ import xiangshan.backend.issue.{FpScheduler, IntScheduler, VecScheduler}
...
@@ -738,12 +739,12 @@ class CtrlBlockImp(
...
@@ -827,9 +829,30 @@ class CtrlBlockImp(
...
@@ -930,6 +953,7 @@ class CtrlBlockIO()(implicit p: Parameters, params: BackendParams) extends XSBun
...
@@ -947,6 +971,7 @@ class CtrlBlockIO()(implicit p: Parameters, params: BackendParams) extends XSBun
...
index ead2255d927..cd862fd1c88 100644
...
@@ -932,7 +941,9 @@ class RegionIO(val params: SchdBlockParams)(implicit p: Parameters) extends XSBu
...
index 704018b24eb..b94e06e8ab2 100644
...
@@ -1075,7 +1064,7 @@ class Dispatch(implicit p: Parameters) extends XSModule with HasPerfEvents with
...
@@ -1148,11 +1139,12 @@ class Dispatch(implicit p: Parameters) extends XSModule with HasPerfEvents with
...
index 83b5955f8e5..ffaef41caae 100644
--- a/src/main/scala/xiangshan/backend/rename/Rename.scala
+++ b/src/main/scala/xiangshan/backend/rename/Rename.scala
@@ -95,6 +95,9 @@ class Rename(implicit p: Parameters) extends XSModule with HasCircularQueuePtrHe
     // perf only
...
@@ -925,9 +928,22 @@ class Rename(implicit p: Parameters) extends XSModule with HasCircularQueuePtrHe
...
@@ -935,6 +951,11 @@ class Rename(implicit p: Parameters) extends XSModule with HasCircularQueuePtrHe
...
index 27311e84e14..3131ea0e3c8 100644
...
@@ -366,8 +368,10 @@ class RobImp(override val wrapper: Rob)(implicit p: Parameters, params: BackendP
...
+
    ...
    * connection of [[rab]]
    */
@@ -1258,7 +1262,6 @@ class RobImp(override val wrapper: Rob)(implicit p: Parameters, params: BackendP
   }
...
@@ -1520,6 +1523,43 @@ class RobImp(override val wrapper: Rob)(implicit p: Parameters, params: BackendP
     }
   }
...
index 4f998e88eb7..9134735c66b 100644
...
index 41f9221b2ff..e52671006de 100644
...
@@ -1004,6 +1007,7 @@ package object xiangshan {
