# Commit Log
- Issue: #6067
- Issue URL: https://github.com/OpenXiangShan/XiangShan/pull/6067
- Issue state: closed
- Tested RTL commit: -
- Related PR: #6067
- PR URL: https://github.com/OpenXiangShan/XiangShan/pull/6067
- Changed files: 2
- Additions: 8
- Deletions: 5
...
index 644d12fbdb8..de77aabf1e4 100644
...
index 3bf4fcb5a2b..7dcdb06fc2f 100644
--- a/src/main/scala/xiangshan/backend/fu/NewCSR/NewCSR.scala
+++ b/src/main/scala/xiangshan/backend/fu/NewCSR/NewCSR.scala
@@ -410,7 +410,7 @@ class NewCSR(implicit val p: Parameters) extends Module
...
@@ -1156,7 +1156,10 @@ class NewCSR(implicit val p: Parameters) extends Module
...
@@ -1546,8 +1549,8 @@ class NewCSR(implicit val p: Parameters) extends Module
...
@@ -1575,7 +1578,7 @@ class NewCSR(implicit val p: Parameters) extends Module
