# Commit Log
- Issue: #3935
- Issue URL: https://github.com/OpenXiangShan/XiangShan/pull/3935
- Issue state: closed
- Tested RTL commit: -
- Related PR: #3935
- PR URL: https://github.com/OpenXiangShan/XiangShan/pull/3935
- Changed files: 1
- Additions: 192
- Deletions: 73
...
index b038b3be2a3..b99b9b59658 100644
...
@@ -34,18 +35,25 @@ import xiangshan._
...
@@ -129,6 +143,67 @@ class FakeITTageTable()(implicit p: Parameters) extends ITTageModule {
...
@@ -378,6 +456,8 @@ class ITTage(implicit p: Parameters) extends BaseITTage {
