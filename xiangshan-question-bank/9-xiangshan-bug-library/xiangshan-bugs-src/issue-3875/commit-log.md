# Commit Log
- Issue: #3875
- Issue URL: https://github.com/OpenXiangShan/XiangShan/pull/3875
- Issue state: closed
- Tested RTL commit: -
- Related PR: #3875
- PR URL: https://github.com/OpenXiangShan/XiangShan/pull/3875
- Changed files: 3
- Additions: 13
- Deletions: 18
...
index 81b933f726f..0c6597d7335 100644
...
index 5ce1bc5b37f..328d8752580 100644
...
@@ -82,12 +82,10 @@ class TrapEntryMEventModule(implicit val p: Parameters) extends Module with CSRE
   private val tvalFillInst     = isIllegalInst
...
index d93720bd41f..8b72a740351 100644
...
@@ -85,18 +85,17 @@ class TrapEntryVSEventModule(implicit val p: Parameters) extends Module with CSR
   // We fill pc here
