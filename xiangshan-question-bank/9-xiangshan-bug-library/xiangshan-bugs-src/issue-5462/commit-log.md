# Commit Log
- Issue: #5462
- Issue URL: https://github.com/OpenXiangShan/XiangShan/pull/5462
- Issue state: closed
- Tested RTL commit: -
- Related PR: #5462
- PR URL: https://github.com/OpenXiangShan/XiangShan/pull/5462
- Changed files: 4
- Additions: 30
- Deletions: 38
...
index b8849eb5e24..c60dc5a8788 100644
--- a/src/main/scala/xiangshan/backend/Backend.scala
+++ b/src/main/scala/xiangshan/backend/Backend.scala
@@ -206,6 +206,7 @@ class BackendInlinedImp(override val wrapper: BackendInlined)(implicit p: Parame
...
index a25c6062262..50d50c502e0 100644
...
index 3431c03187f..e885377144e 100644
...
index 7741b8fd938..db5fe33b06e 100644
...
@@ -15,8 +15,6 @@ class RedirectGenerator(implicit p: Parameters) extends XSModule
...
@@ -32,12 +30,6 @@ class RedirectGenerator(implicit p: Parameters) extends XSModule
