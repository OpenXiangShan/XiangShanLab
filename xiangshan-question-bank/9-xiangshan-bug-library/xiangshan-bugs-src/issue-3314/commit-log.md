# Commit Log
- Issue: #3314
- Issue URL: https://github.com/OpenXiangShan/XiangShan/pull/3314
- Issue state: closed
- Tested RTL commit: -
- Related PR: #3314
- PR URL: https://github.com/OpenXiangShan/XiangShan/pull/3314
- Changed files: 1
- Additions: 1
- Deletions: 1
...
index cd7d0164419..8523e618b45 100644
...
+  val B = RO( 1).withReset(1.U) // Bitmanip extension, contains `Zba`, `Zbb` and `Zbs`
