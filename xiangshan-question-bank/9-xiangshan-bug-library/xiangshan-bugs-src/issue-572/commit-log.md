# Commit Log
- Issue: #572
- Issue URL: https://github.com/OpenXiangShan/XiangShan/pull/572
- Issue state: closed
- Tested RTL commit: -
- Related PR: #572
- PR URL: https://github.com/OpenXiangShan/XiangShan/pull/572
- Changed files: 1
- Additions: 84
- Deletions: 68
...
## Diff
```diff
diff --git a/src/main/scala/xiangshan/cache/TLB.scala b/src/main/scala/xiangshan/cache/TLB.scala
index e01d615e572..63af3a83f20 100644
--- a/src/main/scala/xiangshan/cache/TLB.scala
+++ b/src/main/scala/xiangshan/cache/TLB.scala
...
@@ -498,13 +515,12 @@ class TLB(Width: Int, isDtlb: Boolean) extends TlbModule with HasCSRConst{
