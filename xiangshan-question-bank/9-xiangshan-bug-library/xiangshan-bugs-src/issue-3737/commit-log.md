# Commit Log
- Issue: #3737
- Issue URL: https://github.com/OpenXiangShan/XiangShan/pull/3737
- Issue state: closed
- Tested RTL commit: -
- Related PR: #3737
- PR URL: https://github.com/OpenXiangShan/XiangShan/pull/3737
- Changed files: 5
- Additions: 43
- Deletions: 54
...
index f6ff0f948d2..c35999c4f35 100644
...
@@ -174,7 +174,6 @@ object EntryBundles extends HasCircularQueuePtrHelper {
...
@@ -188,10 +187,10 @@ object EntryBundles extends HasCircularQueuePtrHelper {
...
@@ -279,18 +278,22 @@ object EntryBundles extends HasCircularQueuePtrHelper {
     }.reduce(_ || _)
   }
...
@@ -323,15 +326,15 @@ object EntryBundles extends HasCircularQueuePtrHelper {
...
@@ -364,20 +368,15 @@ object EntryBundles extends HasCircularQueuePtrHelper {
...
@@ -438,17 +437,9 @@ object EntryBundles extends HasCircularQueuePtrHelper {
       }
     }
...
@@ -456,10 +447,12 @@ object EntryBundles extends HasCircularQueuePtrHelper {
...
index b0f0276c0ba..24dada2f588 100644
--- a/src/main/scala/xiangshan/backend/issue/OthersEntry.scala
+++ b/src/main/scala/xiangshan/backend/issue/OthersEntry.scala
@@ -53,7 +53,7 @@ class OthersEntry(isComp: Boolean)(implicit p: Parameters, params: IssueBlockPar
...
index e4ddf86a8e7..1f0196df91c 100644
--- a/src/main/scala/xiangshan/backend/regcache/RegCacheTagModule.scala
...
index 5306aa095a1..2de99d4b070 100644
--- a/src/main/scala/xiangshan/backend/rename/BusyTable.scala
+++ b/src/main/scala/xiangshan/backend/rename/BusyTable.scala
@@ -123,11 +123,10 @@ class BusyTable(numReadPorts: Int, numWritePorts: Int, numPhyPregs: Int, pregWB:
...
@@ -139,22 +138,24 @@ class BusyTable(numReadPorts: Int, numWritePorts: Int, numPhyPregs: Int, pregWB:
