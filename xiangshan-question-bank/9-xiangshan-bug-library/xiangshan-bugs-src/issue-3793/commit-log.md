# Commit Log
- Issue: #3793
- Issue URL: https://github.com/OpenXiangShan/XiangShan/pull/3793
- Issue state: closed
- Tested RTL commit: -
- Related PR: #3793
- PR URL: https://github.com/OpenXiangShan/XiangShan/pull/3793
- Changed files: 20
- Additions: 105
- Deletions: 15
...
index e3cd34c3492..7c4bd5491a0 160000
--- a/difftest
+++ b/difftest
@@ -1 +1 @@
-Subproject commit e3cd34c3492ce0c2dde0078ecce966d98d79c2e4
+Subproject commit 7c4bd5491a0482db79a071cbfba9e730ce498b32
diff --git a/src/main/scala/top/Top.scala b/src/main/scala/top/Top.scala
index 1cf9c444c35..176b04e5290 100644
...
index d995608d8a3..0eac365e1c6 100644
--- a/src/main/scala/top/XSNoCTop.scala
+++ b/src/main/scala/top/XSNoCTop.scala
@@ -110,6 +110,7 @@ class XSNoCTop()(implicit p: Parameters) extends BaseXSSoc with HasSoCParameter
...
+      val riscv_critical_error = Output(Bool())
       ...
       val chi = new PortIO
@@ -146,6 +147,7 @@ class XSNoCTop()(implicit p: Parameters) extends BaseXSSoc with HasSoCParameter
...
index 884795ed150..6b037aaacf5 100644
...
index 01686003206..47d2001fb70 100644
...
index ef2427c57bd..9890889f692 100644
...
@@ -236,6 +237,7 @@ class XSCoreImp(outer: XSCoreBase) extends LazyModuleImp(outer)
...
index 4fd6d226f3a..07776dd595e 100644
...
@@ -135,6 +136,8 @@ class XSTile()(implicit p: Parameters) extends LazyModule
...
index f76c07b1953..1a2477279c6 100644
...
index 373b7e9474c..afe9389619a 100644
...
index fd40b84233f..a1678d4ff35 100644
...
index 6f7f31c57df..68c8bd0caaa 100644
...
index e8f04cd055b..50fe87e485b 100644
...
index 86ea304d82b..46e05805259 100644
...
index 81d5cef9c74..beea16a1c02 100644
...
index f05aef1d956..88925d9527b 100644
...
index 317d69fe3ec..334c3fd699a 100644
...
index b1d6e1bde00..533e97d548a 100644
...
@@ -1277,6 +1278,11 @@ class NewCSR(implicit val p: Parameters) extends Module
...
index 70b7fdba7c1..8ecac7460e4 100644
...
@@ -289,6 +289,9 @@ class CSR(cfg: FuConfig)(implicit p: Parameters) extends FuncUnit(cfg)
...
index 04df1879142..783f2e5487f 100644
...
@@ -1547,6 +1555,23 @@ class RobImp(override val wrapper: Rob)(implicit p: Parameters, params: BackendP
   )
   generatePerfEvent()
...
index 051d07961ce..dca69bda5ca 160000
--- a/utility
+++ b/utility
@@ -1 +1 @@
