# Commit Log
- Issue: #5273
- Issue URL: https://github.com/OpenXiangShan/XiangShan/pull/5273
- Issue state: closed
- Tested RTL commit: -
- Related PR: #5273
- PR URL: https://github.com/OpenXiangShan/XiangShan/pull/5273
- Changed files: 1
- Additions: 39
- Deletions: 35
...
index af9e1e53add..8818692b002 100644
--- a/src/main/scala/xiangshan/frontend/ftq/ResolveQueue.scala
+++ b/src/main/scala/xiangshan/frontend/ftq/ResolveQueue.scala
@@ -46,22 +46,48 @@ class ResolveQueue(implicit p: Parameters) extends FtqModule with HalfAlignHelpe
...
@@ -76,7 +102,7 @@ class ResolveQueue(implicit p: Parameters) extends FtqModule with HalfAlignHelpe
   })
...
@@ -93,37 +119,15 @@ class ResolveQueue(implicit p: Parameters) extends FtqModule with HalfAlignHelpe
     }
   }
