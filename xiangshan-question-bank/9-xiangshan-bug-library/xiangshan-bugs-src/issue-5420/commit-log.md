# Commit Log
- Issue: #5420
- Issue URL: https://github.com/OpenXiangShan/XiangShan/pull/5420
- Issue state: closed
- Tested RTL commit: -
- Related PR: #5420
- PR URL: https://github.com/OpenXiangShan/XiangShan/pull/5420
- Changed files: 1
- Additions: 11
- Deletions: 13
...
index 0508713ca15..c3b057ebaf7 100644
--- a/src/main/scala/xiangshan/backend/decode/DecodeUnit.scala
+++ b/src/main/scala/xiangshan/backend/decode/DecodeUnit.scala
@@ -876,6 +876,16 @@ class DecodeUnit(implicit p: Parameters) extends XSModule with DecodeUnitConstan
...
@@ -902,7 +912,7 @@ class DecodeUnit(implicit p: Parameters) extends XSModule with DecodeUnitConstan
...
@@ -1104,16 +1114,6 @@ class DecodeUnit(implicit p: Parameters) extends XSModule with DecodeUnitConstan
...
@@ -1133,7 +1133,6 @@ class DecodeUnit(implicit p: Parameters) extends XSModule with DecodeUnitConstan
...
@@ -1145,7 +1144,6 @@ class DecodeUnit(implicit p: Parameters) extends XSModule with DecodeUnitConstan
     decodedInst.waitForward := false.B
     decodedInst.blockBackward := false.B
