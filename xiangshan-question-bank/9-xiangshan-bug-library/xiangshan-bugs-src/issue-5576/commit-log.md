# Commit Log
- Issue: #5576
- Issue URL: https://github.com/OpenXiangShan/XiangShan/pull/5576
- Issue state: closed
- Tested RTL commit: -
- Related PR: #5576
- PR URL: https://github.com/OpenXiangShan/XiangShan/pull/5576
- Changed files: 20
- Additions: 132
- Deletions: 67
...
- `src/main/scala/xiangshan/backend/ctrlblock/MemCtrl.scala`
...
index 6320ae14291..1f8f23ce552 100644
--- a/src/main/scala/xiangshan/Bundle.scala
+++ b/src/main/scala/xiangshan/Bundle.scala
@@ -228,6 +228,7 @@ class Redirect(implicit p: Parameters) extends FrontendRedirect {
...
@@ -241,6 +242,12 @@ class Redirect(implicit p: Parameters) extends FrontendRedirect {
...
index 738e089dfb7..a47d9a9c9b0 100644
--- a/src/main/scala/xiangshan/Parameters.scala
+++ b/src/main/scala/xiangshan/Parameters.scala
@@ -785,7 +785,7 @@ trait HasXSParameter {
...
index 26d626f2e22..57390d25c5b 100644
--- a/src/main/scala/xiangshan/XSCore.scala
+++ b/src/main/scala/xiangshan/XSCore.scala
@@ -143,6 +143,7 @@ class XSCoreImp(outer: XSCoreBase) extends LazyModuleImp(outer)
     sink := source
   }
...
index 764c191e220..d54aa58ec2a 100644
--- a/src/main/scala/xiangshan/backend/Backend.scala
+++ b/src/main/scala/xiangshan/backend/Backend.scala
@@ -216,6 +216,7 @@ class BackendInlinedImp(override val wrapper: BackendInlined)(implicit p: Parame
...
@@ -633,6 +634,7 @@ class BackendMemIO(implicit p: Parameters, params: BackendParams) extends XSBund
...
@@ -1454,7 +1454,7 @@ class ExuOutputVLoad(val params: ExeUnitParams)(implicit val p: Parameters) exte
...
index aec3de22bfd..5442a5e6cca 100644
...
@@ -657,9 +668,9 @@ class CtrlBlockImp(
   }
...
diff --git a/src/main/scala/xiangshan/backend/ctrlblock/MemCtrl.scala b/src/main/scala/xiangshan/backend/ctrlblock/MemCtrl.scala
index 6f3a131cca3..45f4f9a682d 100644
--- a/src/main/scala/xiangshan/backend/ctrlblock/MemCtrl.scala
+++ b/src/main/scala/xiangshan/backend/ctrlblock/MemCtrl.scala
...
index db5fe33b06e..241ca64ff66 100644
...
@@ -19,8 +19,6 @@ class RedirectGenerator(implicit p: Parameters) extends XSModule
...
@@ -62,22 +60,5 @@ class RedirectGenerator(implicit p: Parameters) extends XSModule
...
index 42b4a211c5f..14a9f9b63be 100644
...
index f0aef4cd72a..4c3dc84dbf3 100644
...
index 77f9b1f52d2..0f6e3e1e4d1 100644
--- a/src/main/scala/xiangshan/backend/issue/IssueQueue.scala
+++ b/src/main/scala/xiangshan/backend/issue/IssueQueue.scala
@@ -322,7 +322,7 @@ class IssueQueueImp(implicit p: Parameters, params: IssueBlockParams) extends XS
       }
...
index c39b617ae7d..5fca9bcc78c 100644
...
index 7bf336783da..a321c28d941 100644
...
index 180343aefc1..94df79888bb 100644
...
index faaf09ffc00..5712fef76ae 100644
...
@@ -193,6 +196,7 @@ class LoadQueueRAW(implicit p: Parameters) extends XSModule
...
@@ -201,6 +205,7 @@ class LoadQueueRAW(implicit p: Parameters) extends XSModule
...
@@ -295,7 +300,7 @@ class LoadQueueRAW(implicit p: Parameters) extends XSModule
...
@@ -329,12 +334,16 @@ class LoadQueueRAW(implicit p: Parameters) extends XSModule
...
@@ -351,6 +360,7 @@ class LoadQueueRAW(implicit p: Parameters) extends XSModule
...
@@ -360,15 +370,30 @@ class LoadQueueRAW(implicit p: Parameters) extends XSModule
   })
...
index d01bc61dd13..83bcd18721f 100644
...
index d69a91e0a70..d6d49fa09d9 100644
