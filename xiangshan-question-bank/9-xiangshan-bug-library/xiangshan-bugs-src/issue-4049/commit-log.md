# Commit Log
- Issue: #4049
- Issue URL: https://github.com/OpenXiangShan/XiangShan/pull/4049
- Issue state: closed
- Tested RTL commit: -
- Related PR: #4049
- PR URL: https://github.com/OpenXiangShan/XiangShan/pull/4049
- Changed files: 50
- Additions: 1739
- Deletions: 1296
...
- `src/main/scala/xiangshan/backend/fu/wrapper/FALU.scala`
- `src/main/scala/xiangshan/backend/fu/wrapper/FDivSqrt.scala`
- `src/main/scala/xiangshan/backend/fu/wrapper/FMA.scala`
...
- `src/main/scala/xiangshan/backend/regcache/RegCacheTagTable.scala`
...
- `src/test/scala/xiangshan/backend/dispatch/Dispatch2IqMain.scala`

## Diff
```diff
diff --git a/src/main/scala/xiangshan/Bundle.scala b/src/main/scala/xiangshan/Bundle.scala
index a5875e8494e..261286f8581 100644
...
index 586fe9d52b0..b236e8594fe 100644
--- a/src/main/scala/xiangshan/Parameters.scala
+++ b/src/main/scala/xiangshan/Parameters.scala
@@ -229,7 +229,7 @@ case class XSCoreParameters
...
@@ -410,7 +410,7 @@ case class XSCoreParameters
...
@@ -430,20 +430,15 @@ case class XSCoreParameters
     SchdBlockParams(Seq(
       IssueBlockParams(Seq(
...
+      ), numEntries = 18, numEnq = 2, numComp = 14),
       ...
       numDeqOutside = 0,
@@ -459,14 +454,14 @@ case class XSCoreParameters
       IssueBlockParams(Seq(
...
+      ), numEntries = 10, numEnq = 2, numComp = 6),
       ...
       numDeqOutside = 0,
@@ -483,31 +478,31 @@ case class XSCoreParameters
     SchdBlockParams(Seq(
       IssueBlockParams(Seq(
...
+      ), numEntries = 16, numEnq = 2, numComp = 12),
       ...
       numDeqOutside = 0,
@@ -527,17 +522,9 @@ case class XSCoreParameters
       ),
...
index 11196085d05..633511b225d 100644
...
index 10146f0e7ad..b0e208b7583 100644
...
@@ -221,6 +219,18 @@ class BackendInlinedImp(override val wrapper: BackendInlined)(implicit p: Parame
...
@@ -242,17 +252,51 @@ class BackendInlinedImp(override val wrapper: BackendInlined)(implicit p: Parame
...
@@ -264,22 +308,62 @@ class BackendInlinedImp(override val wrapper: BackendInlined)(implicit p: Parame
...
@@ -291,15 +375,20 @@ class BackendInlinedImp(override val wrapper: BackendInlined)(implicit p: Parame
...
@@ -310,13 +399,17 @@ class BackendInlinedImp(override val wrapper: BackendInlined)(implicit p: Parame
...
@@ -338,6 +431,7 @@ class BackendInlinedImp(override val wrapper: BackendInlined)(implicit p: Parame
...
@@ -350,15 +444,20 @@ class BackendInlinedImp(override val wrapper: BackendInlined)(implicit p: Parame
...
@@ -455,8 +554,7 @@ class BackendInlinedImp(override val wrapper: BackendInlined)(implicit p: Parame
     }
   }
...
@@ -692,7 +790,7 @@ class BackendInlinedImp(override val wrapper: BackendInlined)(implicit p: Parame
...
@@ -715,13 +813,6 @@ class BackendInlinedImp(override val wrapper: BackendInlined)(implicit p: Parame
...
@@ -740,7 +831,6 @@ class BackendInlinedImp(override val wrapper: BackendInlined)(implicit p: Parame
...
@@ -778,7 +868,6 @@ class BackendInlinedImp(override val wrapper: BackendInlined)(implicit p: Parame
...
@@ -855,7 +944,6 @@ class BackendMemIO(implicit p: Parameters, params: BackendParams) extends XSBund
...
-  val loadPcRead = Vec(params.LduCnt, Output(UInt(VAddrBits.W)))
   ...
   // Input
@@ -951,8 +1039,7 @@ class BackendIO(implicit p: Parameters, params: BackendParams) extends XSBundle
...
index 4a738d65f44..d60ae05603a 100644
...
@@ -86,17 +89,12 @@ class CtrlBlockImp(
...
@@ -112,7 +110,7 @@ class CtrlBlockImp(
...
@@ -198,6 +196,10 @@ class CtrlBlockImp(
...
@@ -215,27 +217,54 @@ class CtrlBlockImp(
...
@@ -249,12 +278,12 @@ class CtrlBlockImp(
...
@@ -267,7 +296,8 @@ class CtrlBlockImp(
...
@@ -280,13 +310,16 @@ class CtrlBlockImp(
...
@@ -432,10 +465,13 @@ class CtrlBlockImp(
...
@@ -473,6 +509,8 @@ class CtrlBlockImp(
...
@@ -483,6 +521,7 @@ class CtrlBlockImp(
...
@@ -536,6 +575,10 @@ class CtrlBlockImp(
...
@@ -573,43 +616,53 @@ class CtrlBlockImp(
...
@@ -703,11 +756,11 @@ class CtrlBlockImp(
...
@@ -725,17 +778,53 @@ class CtrlBlockIO()(implicit p: Parameters, params: BackendParams) extends XSBun
...
+    val pcToDataPathIO = new PcToDataPathIO(params)
   ...
   val toExuBlock = new Bundle {
     val flush = ValidIO(new Redirect)
@@ -743,8 +832,6 @@ class CtrlBlockIO()(implicit p: Parameters, params: BackendParams) extends XSBun
...
@@ -753,7 +840,6 @@ class CtrlBlockIO()(implicit p: Parameters, params: BackendParams) extends XSBun
...
@@ -793,7 +879,7 @@ class CtrlBlockIO()(implicit p: Parameters, params: BackendParams) extends XSBun
...
index 3b2c6f1ee70..82eb56c75e4 100644
...
@@ -336,7 +335,7 @@ class MemBlockInlinedImp(outer: MemBlockInlined) extends LazyModuleImp(outer)
...
@@ -1939,7 +1940,7 @@ class MemBlockInlinedImp(outer: MemBlockInlined) extends LazyModuleImp(outer)
...
@@ -1950,7 +1951,10 @@ class MemBlockInlinedImp(outer: MemBlockInlined) extends LazyModuleImp(outer)
...
index 9237193b70a..addb100ce48 100644
...
index ae6e8055e8a..9e157c23371 100644
...
+import xiangshan.backend.fu.FuType
 ...
 class BypassNetworkIO()(implicit p: Parameters, params: BackendParams) extends XSBundle {
   // params
@@ -169,6 +170,20 @@ class BypassNetwork()(implicit p: Parameters, params: BackendParams) extends XSM
         )
       )
     }
...
index c019dc56be0..ee386869806 100644
...
index 149db61b249..40fc0cee578 100644
...
index 719e3a23e43..1b3d82c2fcb 100644
...
@@ -308,9 +365,4 @@ class FPDecoder(implicit p: Parameters) extends XSModule{
...
index 2adfa8458b6..62877662b2b 100644
...
@@ -258,6 +255,8 @@ case class ExeUnitParams(
...
index 2f59ddd49fa..481e4e1f7fc 100644
...
@@ -191,6 +190,8 @@ case class FuConfig (
...
index 334c3fd699a..68f6e48acae 100644
...
@@ -176,13 +180,11 @@ trait HasPipelineReg { this: FuncUnit =>
...
@@ -190,59 +192,59 @@ trait HasPipelineReg { this: FuncUnit =>
       case(( ctrl,data), perf) => {
...
diff --git a/src/main/scala/xiangshan/backend/fu/Jump.scala b/src/main/scala/xiangshan/backend/fu/Jump.scala
index 61f3a4bb027..227951229b7 100644
--- a/src/main/scala/xiangshan/backend/fu/Jump.scala
+++ b/src/main/scala/xiangshan/backend/fu/Jump.scala
@@ -35,24 +35,21 @@ class JumpDataModule(implicit p: Parameters) extends XSModule {
   val io = IO(new Bundle() {
...
diff --git a/src/main/scala/xiangshan/backend/fu/fpu/FDivSqrt.scala b/src/main/scala/xiangshan/backend/fu/fpu/FDivSqrt.scala
deleted file mode 100644
index 3b7cec0731a..00000000000
...
-  )
-}
diff --git a/src/main/scala/xiangshan/backend/fu/fpu/FPToFP.scala b/src/main/scala/xiangshan/backend/fu/fpu/FPToFP.scala
deleted file mode 100644
index 20e241fc554..00000000000
...
-}
diff --git a/src/main/scala/xiangshan/backend/fu/fpu/FPToInt.scala b/src/main/scala/xiangshan/backend/fu/fpu/FPToInt.scala
deleted file mode 100644
index 93fcada046f..00000000000
...
index 489f71bbae7..fbb4bb925c3 100644
...
index ad6f4153dfd..d11c67e1070 100644
...
@@ -2,24 +2,28 @@ package xiangshan.backend.fu.wrapper
...
@@ -32,9 +36,10 @@ class BranchUnit(cfg: FuConfig)(implicit p: Parameters) extends FuncUnit(cfg) {
...
diff --git a/src/main/scala/xiangshan/backend/fu/wrapper/FALU.scala b/src/main/scala/xiangshan/backend/fu/wrapper/FALU.scala
index d936c9eee84..c6a6757d268 100644
--- a/src/main/scala/xiangshan/backend/fu/wrapper/FALU.scala
+++ b/src/main/scala/xiangshan/backend/fu/wrapper/FALU.scala
@@ -21,14 +21,14 @@ class FAlu(cfg: FuConfig)(implicit p: Parameters) extends FpPipedFuncUnit(cfg) {
   // modules
...
index 1cbaa13f0fe..05a9f449f3b 100644
...
diff --git a/src/main/scala/xiangshan/backend/fu/wrapper/FMA.scala b/src/main/scala/xiangshan/backend/fu/wrapper/FMA.scala
index 2b5d7e6c0e6..6f1279a7bbd 100644
--- a/src/main/scala/xiangshan/backend/fu/wrapper/FMA.scala
+++ b/src/main/scala/xiangshan/backend/fu/wrapper/FMA.scala
...
index b0bc6ee7f96..c0c92731b90 100644
...
index c5284506702..5f04f0c1faa 100644
--- a/src/main/scala/xiangshan/backend/issue/Entries.scala
+++ b/src/main/scala/xiangshan/backend/issue/Entries.scala
@@ -135,8 +135,8 @@ class Entries(implicit p: Parameters, params: IssueBlockParams) extends XSModule
...
@@ -533,6 +533,8 @@ class EntriesIO(implicit p: Parameters, params: IssueBlockParams) extends XSBund
   // wakeup
...
index b615b56676d..ff87e9ab70f 100644
...
@@ -272,7 +272,13 @@ case class IssueBlockParams(
...
index b34892b0e8f..fcbc070a0e5 100644
...
@@ -774,6 +788,7 @@ class IssueQueueImp(override val wrapper: IssueQueue)(implicit p: Parameters, va
     }
...
@@ -1131,6 +1146,7 @@ class IssueQueueMemAddrImp(override val wrapper: IssueQueue)(implicit p: Paramet
...
@@ -35,7 +34,6 @@ class Scheduler(val params: SchdBlockParams)(implicit p: Parameters) extends Laz
...
@@ -50,7 +48,10 @@ class Scheduler(val params: SchdBlockParams)(implicit p: Parameters) extends Laz
...
@@ -58,15 +59,13 @@ class SchedulerIO()(implicit params: SchdBlockParams, p: Parameters) extends XSB
...
@@ -78,6 +77,16 @@ class SchedulerIO()(implicit params: SchdBlockParams, p: Parameters) extends XSB
...
@@ -89,6 +98,7 @@ class SchedulerIO()(implicit params: SchdBlockParams, p: Parameters) extends XSB
...
@@ -113,9 +123,6 @@ class SchedulerIO()(implicit params: SchdBlockParams, p: Parameters) extends XSB
...
@@ -148,215 +155,52 @@ abstract class SchedulerImpBase(wrapper: Scheduler)(implicit params: SchdBlockPa
   // alias
...
@@ -381,6 +225,15 @@ abstract class SchedulerImpBase(wrapper: Scheduler)(implicit params: SchdBlockPa
...
@@ -465,13 +318,11 @@ abstract class SchedulerImpBase(wrapper: Scheduler)(implicit params: SchdBlockPa
   }
...
@@ -487,14 +338,10 @@ class SchedulerArithImp(override val wrapper: Scheduler)(implicit params: SchdBl
     with HasXSParameter
     with HasPerfEvents
 {
...
@@ -506,7 +353,16 @@ class SchedulerArithImp(override val wrapper: Scheduler)(implicit params: SchdBl
...
@@ -519,10 +375,20 @@ class SchedulerMemImp(override val wrapper: Scheduler)(implicit params: SchdBloc
     with HasXSParameter
     with HasPerfEvents
 {
...
@@ -545,7 +411,6 @@ class SchedulerMemImp(override val wrapper: Scheduler)(implicit params: SchdBloc
...
@@ -556,6 +421,13 @@ class SchedulerMemImp(override val wrapper: Scheduler)(implicit params: SchdBloc
...
@@ -604,23 +476,6 @@ class SchedulerMemImp(override val wrapper: Scheduler)(implicit params: SchdBloc
...
@@ -630,9 +485,19 @@ class SchedulerMemImp(override val wrapper: Scheduler)(implicit params: SchdBloc
...
@@ -666,6 +531,13 @@ class SchedulerMemImp(override val wrapper: Scheduler)(implicit params: SchdBloc
...
@@ -679,26 +551,6 @@ class SchedulerMemImp(override val wrapper: Scheduler)(implicit params: SchdBloc
       sink := source
   }
...
diff --git a/src/main/scala/xiangshan/backend/regcache/RegCacheTagTable.scala b/src/main/scala/xiangshan/backend/regcache/RegCacheTagTable.scala
index 6a7e7a4deea..709a57111e5 100644
--- a/src/main/scala/xiangshan/backend/regcache/RegCacheTagTable.scala
+++ b/src/main/scala/xiangshan/backend/regcache/RegCacheTagTable.scala
...
index bad3c41cb20..05a4c05d37e 100644
...
@@ -223,6 +224,46 @@ object IntRegFile {
   }
 }
...
+    val wakeUpMem = Flipped(backendParams.memSchdParams.get.genIQWakeUpOutValidBundle)
     ...
     val og0Cancel = Input(ExuVec())
     // cancelFromMem
@@ -54,13 +58,11 @@ class BusyTable(numReadPorts: Int, numWritePorts: Int, numPhyPregs: Int, pregWB:
...
@@ -80,12 +82,13 @@ class BusyTable(numReadPorts: Int, numWritePorts: Int, numPhyPregs: Int, pregWB:
   }
...
@@ -131,9 +134,9 @@ class BusyTable(numReadPorts: Int, numWritePorts: Int, numPhyPregs: Int, pregWB:
     when(wakeUpMask(idx)) {
...
+      }
   ...
   /*
@@ -153,21 +156,22 @@ class BusyTable(numReadPorts: Int, numWritePorts: Int, numPhyPregs: Int, pregWB:
...
@@ -183,9 +187,10 @@ class BusyTable(numReadPorts: Int, numWritePorts: Int, numPhyPregs: Int, pregWB:
...
+class VlBusyTable(numReadPorts: Int, numWritePorts: Int, numPhyPregs: Int, pregWB: PregWB)(implicit p: Parameters) extends BusyTable(numReadPorts, numWritePorts, numPhyPregs, pregWB) {
   ...
   val io_vl_Wb = IO(new Bundle() {
     val vlWriteBackInfo = new Bundle {
@@ -249,3 +254,4 @@ class VlBusyTable(numReadPorts: Int, numWritePorts: Int, numPhyPregs: Int, pregW
...
index 360850ac02d..8d4855ac611 100644
...
@@ -398,6 +399,10 @@ class Rename(implicit p: Parameters) extends XSModule with HasCircularQueuePtrHe
...
@@ -534,9 +539,10 @@ class Rename(implicit p: Parameters) extends XSModule with HasCircularQueuePtrHe
       }
...
index a02dd081912..91f0e3b15e3 100644
...
index 2d1fc7129ec..130570386a4 100644
...
index 2f785c84d6f..34d8c106e01 100644
...
index 4ef7252587b..e2e25a259f6 100644
...
+  io.enq.canAcceptForDispatch := allowEnqueueForDispatch && !hasBlockBackward && rab.io.canEnqForDispatch && vtypeBuffer.io.canEnqForDispatch && !io.fromVecExcpMod.busy
   ...
   val timer = GTimer()
@@ -347,7 +349,8 @@ class RobImp(override val wrapper: Rob)(implicit p: Parameters, params: BackendP
   rab.io.snpt := io.snpt
...
+  io.rabCommits := RegNext(rab.io.commits)
   ...
   /**
@@ -895,7 +898,8 @@ class RobImp(override val wrapper: Rob)(implicit p: Parameters, params: BackendP
   val numValidEntries = distanceBetween(enqPtr, deqPtr)
...
@@ -918,9 +922,11 @@ class RobImp(override val wrapper: Rob)(implicit p: Parameters, params: BackendP
...
@@ -929,7 +935,7 @@ class RobImp(override val wrapper: Rob)(implicit p: Parameters, params: BackendP
...
@@ -983,7 +989,7 @@ class RobImp(override val wrapper: Rob)(implicit p: Parameters, params: BackendP
...
index 2a6f76a5273..0f47de6ba13 100644
...
index e80066ee343..207e4094209 100644
...
index 49a6f0086bb..01e6ca4eb0b 100644
...
index 25590840e20..5fde17a29da 100644
...
index 13e4451287a..26566749f05 100644
...
diff --git a/src/test/scala/xiangshan/backend/dispatch/Dispatch2IqMain.scala b/src/test/scala/xiangshan/backend/dispatch/Dispatch2IqMain.scala
deleted file mode 100644
index 4abec8d75d1..00000000000
--- a/src/test/scala/xiangshan/backend/dispatch/Dispatch2IqMain.scala
+++ /dev/null
@@ -1,20 +0,0 @@
-package xiangshan.backend.dispatch
-
