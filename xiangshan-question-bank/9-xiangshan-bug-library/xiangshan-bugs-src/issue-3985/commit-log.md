# Commit Log
- Issue: #3985
- Issue URL: https://github.com/OpenXiangShan/XiangShan/pull/3985
- Issue state: closed
- Tested RTL commit: -
- Related PR: #3985
- PR URL: https://github.com/OpenXiangShan/XiangShan/pull/3985
- Changed files: 1
- Additions: 3
- Deletions: 1
...
index 0a9da82b12f..69d1364c152 100644
--- a/src/main/scala/xiangshan/cache/mmu/TLB.scala
+++ b/src/main/scala/xiangshan/cache/mmu/TLB.scala
@@ -104,6 +104,7 @@ class TLB(Width: Int, nRespDups: Int = 1, Block: Seq[Boolean], q: TLBParameters)
...
@@ -160,7 +161,7 @@ class TLB(Width: Int, nRespDups: Int = 1, Block: Seq[Boolean], q: TLBParameters)
     }
   }
...
@@ -224,6 +225,7 @@ class TLB(Width: Int, nRespDups: Int = 1, Block: Seq[Boolean], q: TLBParameters)
