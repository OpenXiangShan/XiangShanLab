# Commit Log
- Issue: #4216
- Issue URL: https://github.com/OpenXiangShan/XiangShan/pull/4216
- Issue state: closed
- Tested RTL commit: -
- Related PR: #4216
- PR URL: https://github.com/OpenXiangShan/XiangShan/pull/4216
- Changed files: 1
- Additions: 33
- Deletions: 17
...
index 8165ae52bf4..f54bc179009 100644
--- a/src/main/scala/xiangshan/frontend/ITTAGE.scala
+++ b/src/main/scala/xiangshan/frontend/ITTAGE.scala
@@ -135,9 +135,9 @@ class RegionEntry(implicit p: Parameters) extends ITTageBundle {
...
@@ -163,11 +163,13 @@ class RegionWays()(implicit p: Parameters) extends XSModule with ITTageParams {
...
@@ -535,8 +537,10 @@ class ITTage(implicit p: Parameters) extends BaseITTage {
...
@@ -544,6 +548,8 @@ class ITTage(implicit p: Parameters) extends BaseITTage {
...
@@ -555,20 +561,29 @@ class ITTage(implicit p: Parameters) extends BaseITTage {
...
@@ -626,6 +641,7 @@ class ITTage(implicit p: Parameters) extends BaseITTage {
