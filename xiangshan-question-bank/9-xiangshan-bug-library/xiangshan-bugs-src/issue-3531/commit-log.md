# Commit Log
- Issue: #3531
- Issue URL: https://github.com/OpenXiangShan/XiangShan/pull/3531
- Issue state: closed
- Tested RTL commit: -
- Related PR: #3531
- PR URL: https://github.com/OpenXiangShan/XiangShan/pull/3531
- Changed files: 4
- Additions: 22
- Deletions: 22
...
index 4aadb7cd029..a28828e94d0 100644
--- a/scripts/parser.py
+++ b/scripts/parser.py
@@ -58,9 +58,7 @@ def __init__(self, name):
...
index a4325bacce5..34a16728c32 100644
...
index c7a430bfa65..1c5df3da3ea 100644
...
index 20e56b2ccc0..c43c2ffe7ff 100644
...
@@ -55,6 +56,7 @@ class LsqEnqIO(implicit p: Parameters) extends MemBlockBundle {
...
@@ -311,23 +313,20 @@ class LsqEnqCtrl(implicit p: Parameters) extends XSModule
...
@@ -370,13 +369,14 @@ class LsqEnqCtrl(implicit p: Parameters) extends XSModule
