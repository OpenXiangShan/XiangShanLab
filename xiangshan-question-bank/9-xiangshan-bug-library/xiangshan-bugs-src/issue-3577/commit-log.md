# Commit Log
- Issue: #3577
- Issue URL: https://github.com/OpenXiangShan/XiangShan/pull/3577
- Issue state: closed
- Tested RTL commit: -
- Related PR: #3577
- PR URL: https://github.com/OpenXiangShan/XiangShan/pull/3577
- Changed files: 15
- Additions: 113
- Deletions: 190
...
- `src/main/scala/xiangshan/backend/fu/NewCSR/CSRFields.scala`
...
index 97c898e71d7..5386e0d5abd 100644
...
index 1c2b32a53f6..803746e56ec 100644
...
+  }
 ...
 trait CSREventBase {
@@ -140,6 +149,16 @@ class TrapEntryEventInput(implicit val p: Parameters) extends Bundle with HasXSP
...
index fca46b78061..15042240f74 100644
...
index 2609fc37037..b4bbb2ffbca 100644
...
index af3ca502f08..60a402b6147 100644
...
@@ -17,13 +17,6 @@ class MretEventOutput extends Bundle with EventUpdatePrivStateOutput with EventO
...
@@ -77,17 +70,10 @@ class MretEventModule(implicit p: Parameters) extends Module with CSREventBase {
...
index bd1e041b7db..0fa64efd417 100644
...
index a705c750f34..9f0c5288452 100644
...
index 683f314eb8a..681d249dccf 100644
...
index a46c4f69697..a59c5c071f0 100644
...
index 3264f31f97b..410d946e22d 100644
...
index 84a99a9392c..c457ba28b45 100644
...
@@ -142,16 +133,10 @@ class TrapEntryVSEventModule(implicit val p: Parameters) extends Module with CSR
   dontTouch(tvalFillGVA)
 }
...
diff --git a/src/main/scala/xiangshan/backend/fu/NewCSR/CSRFields.scala b/src/main/scala/xiangshan/backend/fu/NewCSR/CSRFields.scala
index 4a89bdfd8f6..cd40dd870a0 100644
...
index 6b746a61b21..fc550814c90 100644
...
@@ -498,13 +504,14 @@ class MstatusModule(implicit override val p: Parameters) extends CSRModule("MSta
...
index 3a634371172..d642b8a8391 100644
