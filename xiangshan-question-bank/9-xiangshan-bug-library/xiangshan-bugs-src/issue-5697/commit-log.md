# Commit Log
- Issue: #5697
- Issue URL: https://github.com/OpenXiangShan/XiangShan/pull/5697
- Issue state: closed
- Tested RTL commit: -
- Related PR: #5697
- PR URL: https://github.com/OpenXiangShan/XiangShan/pull/5697
- Changed files: 8
- Additions: 78
- Deletions: 75
...
index 9279fdb20c5..88d1c4f9f00 100644
...
index 2003056c355..ed08b2156b9 100644
...
index 0ec6cf5cc11..f69066fbc0b 100644
...
@@ -796,16 +806,6 @@ class MainPipe(implicit p: Parameters) extends DCacheModule with HasPerfEvents w
   )
...
index 17ab2c7f02a..63971e7bad9 100644
...
@@ -467,16 +466,30 @@ class LoadQueueReplay(implicit p: Parameters) extends XSModule
...
@@ -487,9 +500,9 @@ class LoadQueueReplay(implicit p: Parameters) extends XSModule
...
@@ -501,7 +514,7 @@ class LoadQueueReplay(implicit p: Parameters) extends XSModule
...
@@ -517,7 +530,7 @@ class LoadQueueReplay(implicit p: Parameters) extends XSModule
...
@@ -598,20 +611,6 @@ class LoadQueueReplay(implicit p: Parameters) extends XSModule
...
index fe3233214d0..c4f3cdece84 100644
...
index 29b7334743c..c84bf12dc44 100644
...
index a0eed729099..ff81c9b0bd8 100644
