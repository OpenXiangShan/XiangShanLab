# Commit Log
- Issue: #3382
- Issue URL: https://github.com/OpenXiangShan/XiangShan/pull/3382
- Issue state: closed
- Tested RTL commit: -
- Related PR: #3382
- PR URL: https://github.com/OpenXiangShan/XiangShan/pull/3382
- Changed files: 1
- Additions: 28
- Deletions: 16
...
index 6f90e8b0107..5306aa095a1 100644
--- a/src/main/scala/xiangshan/backend/rename/BusyTable.scala
+++ b/src/main/scala/xiangshan/backend/rename/BusyTable.scala
@@ -75,35 +75,47 @@ class BusyTable(numReadPorts: Int, numWritePorts: Int, numPhyPregs: Int, pregWB:
   }
...
@@ -114,7 +126,7 @@ class BusyTable(numReadPorts: Int, numWritePorts: Int, numPhyPregs: Int, pregWB:
